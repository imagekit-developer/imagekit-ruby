    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Imagekit::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Imagekit::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Imagekit::FilePart.new(value)
          in Imagekit::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Imagekit::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Imagekit::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Imagekit::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Imagekit::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Imagekit::Internal::Type::Converter
              ...
              Imagekit::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Imagekit::Internal::Type::Converter, T::Class[T.anything]) }
        end
