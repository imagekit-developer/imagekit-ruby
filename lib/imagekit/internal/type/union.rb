  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, Imagekit::Internal::Type::Converter, Class]
        #
        # @param spec [Hash{Symbol=>Object}, Proc, Imagekit::Internal::Type::Converter, Class] .
        #
        ...
        private def variant(key, spec = nil)
          meta = Imagekit::Internal::Type::Converter.meta_info(nil, spec)
          variant_info =
            case key
            in Symbol
              [key, Imagekit::Internal::Type::Converter.type_info(spec), meta]
            in Proc | Imagekit::Internal::Type::Converter | Class | Hash
              [nil, Imagekit::Internal::Type::Converter.type_info(key), meta]
            end
        ...
        # @param value [Object]
        #
        # @return [Imagekit::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          case [@discriminator, value]
          in [_, Imagekit::Internal::Type::BaseModel]
            value.class
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, Imagekit::Internal::OMIT)
            end

            return nil if key == Imagekit::Internal::OMIT
        ...
        # @return [Boolean]
        def ==(other)
          Imagekit::Internal::Type::Union === other && other.derefed_variants == derefed_variants
        end
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return Imagekit::Internal::Type::Converter.coerce(target, value, state: state)
          end
        ...
        def dump(value, state:)
          if (target = resolve_variant(value))
            return Imagekit::Internal::Type::Converter.dump(target, value, state: state)
          end

          known_variants.each do
            target = _2.call
            return Imagekit::Internal::Type::Converter.dump(target, value, state: state) if target === value
          end
        ...
        # @return [Object]
        def to_sorbet_type
          types = variants.map { Imagekit::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1) }.uniq
          case types
          in []
            T.noreturn
          in [type]
        ...
        def inspect(depth: 0)
          ...
          members = variants.map { Imagekit::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
