  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Imagekit::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Imagekit::Internal::Util.os,
            "x-stainless-package-version" => Imagekit::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Imagekit::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Imagekit::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Imagekit::Internal::Util.uri_origin(url) != Imagekit::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Imagekit::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Imagekit::Errors::APIConnectionError | (500..)
              Imagekit::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Imagekit::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Imagekit::Internal::Transport::PooledNetRequester.new
          @headers = Imagekit::Internal::Util.normalized_headers(
          ...
          @base_url_components = Imagekit::Internal::Util.parse_uri(base_url)
          @base_url = Imagekit::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        #   @option req [Class<Imagekit::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Imagekit::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Imagekit::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Imagekit::Internal::Util.interpolate_path(uninterpolated_path)

          query = Imagekit::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              Imagekit::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end

          url = Imagekit::Internal::Util.join_parsed_uri(
            @base_url_components,
            {**req, path: path, query: query}
          )
          headers, encoded = Imagekit::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        #
        # @raise [Imagekit::Errors::APIError]
        # @return [Array(Integer, Net::HTTPResponse, Enumerable<String>)]
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          url, headers, max_retries, timeout = request.fetch_values(:url, :headers, :max_retries, :timeout)
          input = {**request.except(:timeout), deadline: Imagekit::Internal::Util.monotonic_secs + timeout}
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Imagekit::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) | Imagekit::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param page [Class<Imagekit::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Imagekit::Internal::Type::BaseStream>, nil]
        #
        # @param model [Imagekit::Internal::Type::Converter, Class, nil]
        #
        # @param options [Imagekit::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Imagekit::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          Imagekit::RequestOptions.validate!(opts)
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[Imagekit::Internal::Type::BasePage[Imagekit::Internal::Type::BaseModel]]),
