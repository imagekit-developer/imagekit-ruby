    ...
    class Beta
      class V2
        class Files
          ...
          #
          # @return [Imagekit::Models::Beta::V2::FileUploadResponse]
          #
          # @see Imagekit::Models::Beta::V2::FileUploadParams
          def upload(params)
            parsed, options = Imagekit::Beta::V2::FileUploadParams.dump_request(params)
            path =
            ...
            @client.request(
              ...
              body: parsed,
              model: Imagekit::Models::Beta::V2::FileUploadResponse,
              options: options
            )
          end
