...
module Imagekit
  module Models
    # @see Imagekit::Resources::BulkJobs#move_folder
    class BulkJobMoveFolderResponse < Imagekit::Internal::Type::BaseModel
      # @!attribute job_id
      ...
      #   {Imagekit::Models::BulkJobMoveFolderResponse} for more details.
      #
