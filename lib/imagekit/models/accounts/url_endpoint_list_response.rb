...
module Imagekit
  module Models
    module Accounts
      class URLEndpointListResponseItem < Imagekit::Internal::Type::BaseModel
        ...
        #   {Imagekit::Models::Accounts::URLEndpointListResponseItem} for more details.
        #
        ...
        # Configuration for third-party URL rewriting.
        #
        # @see Imagekit::Models::Accounts::URLEndpointListResponseItem#url_rewriter
        module URLRewriter
          ...
          class CloudinaryURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::CloudinaryURLRewriter::Type]
            required :type,
                     enum: -> { Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::CloudinaryURLRewriter::Type }
            ...
            #
            #   @param type [Symbol, Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::CloudinaryURLRewriter::Type]

            # @see Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::CloudinaryURLRewriter#type
            module Type
          ...
          class ImgixURLRewriter < Imagekit::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::ImgixURLRewriter::Type]
            required :type,
                     enum: -> { Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::ImgixURLRewriter::Type }

            # @!method initialize(type:)
            #   @param type [Symbol, Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::ImgixURLRewriter::Type]

            # @see Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::ImgixURLRewriter#type
            module Type
              extend Imagekit::Internal::Type::Enum
          ...
          class AkamaiURLRewriter < Imagekit::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::AkamaiURLRewriter::Type]
            required :type,
                     enum: -> { Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::AkamaiURLRewriter::Type }

            # @!method initialize(type:)
            #   @param type [Symbol, Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::AkamaiURLRewriter::Type]

            # @see Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::AkamaiURLRewriter#type
            module Type
              extend Imagekit::Internal::Type::Enum
      ...
      URLEndpointListResponse =
        Imagekit::Internal::Type::ArrayOf[-> { Imagekit::Models::Accounts::URLEndpointListResponseItem }]
    end
  end
end
