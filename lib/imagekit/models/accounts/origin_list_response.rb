  ...
  module Models
    module Accounts
      ...
      module OriginListResponseItem
        ...
        variant :S3, -> { Imagekit::Models::Accounts::OriginListResponseItem::S3 }

        variant :S3_COMPATIBLE, -> { Imagekit::Models::Accounts::OriginListResponseItem::S3Compatible }

        variant :CLOUDINARY_BACKUP, -> { Imagekit::Models::Accounts::OriginListResponseItem::CloudinaryBackup }

        variant :WEB_FOLDER, -> { Imagekit::Models::Accounts::OriginListResponseItem::WebFolder }

        variant :WEB_PROXY, -> { Imagekit::Models::Accounts::OriginListResponseItem::WebProxy }

        variant :GCS, -> { Imagekit::Models::Accounts::OriginListResponseItem::Gcs }

        variant :AZURE_BLOB, -> { Imagekit::Models::Accounts::OriginListResponseItem::AzureBlob }

        variant :AKENEO_PIM, -> { Imagekit::Models::Accounts::OriginListResponseItem::AkeneoPim }
        ...
        class AzureBlob < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::OriginListResponseItem::AzureBlob} for more
          #   details.
          #
          #   @param id [String] Unique identifier for the origin. This is generated by ImageKit when you create
          #
