  ...
  module Models
    module Accounts
      ...
      module OriginResponse
        ...
        variant :S3, -> { Imagekit::Accounts::OriginResponse::S3 }

        variant :S3_COMPATIBLE, -> { Imagekit::Accounts::OriginResponse::S3Compatible }

        variant :CLOUDINARY_BACKUP, -> { Imagekit::Accounts::OriginResponse::CloudinaryBackup }

        variant :WEB_FOLDER, -> { Imagekit::Accounts::OriginResponse::WebFolder }

        variant :WEB_PROXY, -> { Imagekit::Accounts::OriginResponse::WebProxy }

        variant :GCS, -> { Imagekit::Accounts::OriginResponse::Gcs }

        variant :AZURE_BLOB, -> { Imagekit::Accounts::OriginResponse::AzureBlob }

        variant :AKENEO_PIM, -> { Imagekit::Accounts::OriginResponse::AkeneoPim }
