  ...
  module Models
    module Accounts
      ...
      module OriginCreateResponse
        ...
        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::S3 }

        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::S3Compatible }

        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::CloudinaryBackup }

        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::WebFolder }

        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::WebProxy }

        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::GoogleCloudStorageGcs }

        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::AzureBlobStorage }

        variant -> { Imagekit::Models::Accounts::OriginCreateResponse::AkeneoPim }
        ...
        #   @return [Array(Imagekit::Models::Accounts::OriginCreateResponse::S3, Imagekit::Models::Accounts::OriginCreateResponse::S3Compatible, Imagekit::Models::Accounts::OriginCreateResponse::CloudinaryBackup, Imagekit::Models::Accounts::OriginCreateResponse::WebFolder, Imagekit::Models::Accounts::OriginCreateResponse::WebProxy, Imagekit::Models::Accounts::OriginCreateResponse::GoogleCloudStorageGcs, Imagekit::Models::Accounts::OriginCreateResponse::AzureBlobStorage, Imagekit::Models::Accounts::OriginCreateResponse::AkeneoPim)]
      end
    end
  end
end
