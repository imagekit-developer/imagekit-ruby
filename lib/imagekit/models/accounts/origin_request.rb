  ...
  module Models
    module Accounts
      ...
      module OriginRequest
        ...
        variant :S3, -> { Imagekit::Accounts::OriginRequest::S3 }

        variant :S3_COMPATIBLE, -> { Imagekit::Accounts::OriginRequest::S3Compatible }

        variant :CLOUDINARY_BACKUP, -> { Imagekit::Accounts::OriginRequest::CloudinaryBackup }

        variant :WEB_FOLDER, -> { Imagekit::Accounts::OriginRequest::WebFolder }

        variant :WEB_PROXY, -> { Imagekit::Accounts::OriginRequest::WebProxy }

        variant :GCS, -> { Imagekit::Accounts::OriginRequest::Gcs }

        variant :AZURE_BLOB, -> { Imagekit::Accounts::OriginRequest::AzureBlob }

        variant :AKENEO_PIM, -> { Imagekit::Accounts::OriginRequest::AkeneoPim }
