    ...
    module Accounts
      ...
      module Origin
        ...
        class S3 < Imagekit::Internal::Type::BaseModel
          ...
          #   {Imagekit::Models::Accounts::Origin::S3} for more details.
          #
        ...
        class S3Compatible < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::Origin::S3Compatible} for more details.
          #
          #   @param access_key [String] Access key for the bucket.
          #
          #   @param bucket [String] S3 bucket name.
        ...
        class CloudinaryBackup < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::Origin::CloudinaryBackup} for more details.
          #
          #   @param access_key [String] Access key for the bucket.
          #
          #   @param bucket [String] S3 bucket name.
        ...
        class WebFolder < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::Origin::WebFolder} for more details.
          #
        ...
        class WebProxy < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::Origin::WebProxy} for more details.
          #
          #   @param name [String] Display name of the origin.
          #
          #   @param id [String] Unique identifier for the origin. This is generated by ImageKit when you create
        ...
        class Gcs < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::Origin::Gcs} for more details.
          #
          #   @param bucket [String]
          #
        ...
        class AzureBlob < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::Origin::AzureBlob} for more details.
          #
        ...
        class AkeneoPim < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::Origin::AkeneoPim} for more details.
          #
