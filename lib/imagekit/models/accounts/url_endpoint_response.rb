...
module Imagekit
  module Models
    module Accounts
      ...
      class URLEndpointResponse < Imagekit::Internal::Type::BaseModel
        ...
        #
        #   @return [Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Cloudinary, Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Imgix, Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Akamai, nil]
        optional :url_rewriter,
                 union: -> { Imagekit::Accounts::URLEndpointResponse::URLRewriter },
        ...
        #   {Imagekit::Models::Accounts::URLEndpointResponse} for more details.
        #
        ...
        #
        #   @param url_rewriter [Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Cloudinary, Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Imgix, Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Akamai] Configuration for third-party URL rewriting.

        # Configuration for third-party URL rewriting.
        #
        # @see Imagekit::Models::Accounts::URLEndpointResponse#url_rewriter
        module URLRewriter
          extend Imagekit::Internal::Type::Union

          discriminator :type

          variant :CLOUDINARY, -> { Imagekit::Accounts::URLEndpointResponse::URLRewriter::Cloudinary }

          variant :IMGIX, -> { Imagekit::Accounts::URLEndpointResponse::URLRewriter::Imgix }

          variant :AKAMAI, -> { Imagekit::Accounts::URLEndpointResponse::URLRewriter::Akamai }
          ...
          #   @return [Array(Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Cloudinary, Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Imgix, Imagekit::Models::Accounts::URLEndpointResponse::URLRewriter::Akamai)]
        end
      end
    end
  end
