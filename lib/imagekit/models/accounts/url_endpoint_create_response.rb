      ...
      class URLEndpointCreateResponse < Imagekit::Internal::Type::BaseModel
        ...
        module URLRewriter
          ...
          class CloudinaryURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::CloudinaryURLRewriter::Type]
            required :type,
                     enum: -> { Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::CloudinaryURLRewriter::Type }
            ...
            #
            #   @param type [Symbol, Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::CloudinaryURLRewriter::Type]

            # @see Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::CloudinaryURLRewriter#type
            module Type
          ...
          class ImgixURLRewriter < Imagekit::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::ImgixURLRewriter::Type]
            required :type,
                     enum: -> { Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::ImgixURLRewriter::Type }

            # @!method initialize(type:)
            #   @param type [Symbol, Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::ImgixURLRewriter::Type]

            # @see Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::ImgixURLRewriter#type
            module Type
              extend Imagekit::Internal::Type::Enum
          ...
          class AkamaiURLRewriter < Imagekit::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::AkamaiURLRewriter::Type]
            required :type,
                     enum: -> { Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::AkamaiURLRewriter::Type }

            # @!method initialize(type:)
            #   @param type [Symbol, Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::AkamaiURLRewriter::Type]

            # @see Imagekit::Models::Accounts::URLEndpointCreateResponse::URLRewriter::AkamaiURLRewriter#type
            module Type
              extend Imagekit::Internal::Type::Enum
