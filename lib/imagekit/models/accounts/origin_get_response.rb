  ...
  module Models
    module Accounts
      ...
      module OriginGetResponse
        ...
        variant :S3, -> { Imagekit::Models::Accounts::OriginGetResponse::S3 }

        variant :S3_COMPATIBLE, -> { Imagekit::Models::Accounts::OriginGetResponse::S3Compatible }

        variant :CLOUDINARY_BACKUP, -> { Imagekit::Models::Accounts::OriginGetResponse::CloudinaryBackup }

        variant :WEB_FOLDER, -> { Imagekit::Models::Accounts::OriginGetResponse::WebFolder }

        variant :WEB_PROXY, -> { Imagekit::Models::Accounts::OriginGetResponse::WebProxy }

        variant :GCS, -> { Imagekit::Models::Accounts::OriginGetResponse::Gcs }

        variant :AZURE_BLOB, -> { Imagekit::Models::Accounts::OriginGetResponse::AzureBlob }

        variant :AKENEO_PIM, -> { Imagekit::Models::Accounts::OriginGetResponse::AkeneoPim }
        ...
        class Gcs < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::OriginGetResponse::Gcs} for more details.
          #
          #   @param id [String] Unique identifier for the origin. This is generated by ImageKit when you create
          #
          #   @param bucket [String]
        ...
        class AzureBlob < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Accounts::OriginGetResponse::AzureBlob} for more details.
          #
          #   @param id [String] Unique identifier for the origin. This is generated by ImageKit when you create
          #
