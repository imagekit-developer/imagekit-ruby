  ...
  module Models
    module Accounts
      class URLEndpointRequest < Imagekit::Internal::Type::BaseModel
        ...
        #
        #   @return [Imagekit::Models::Accounts::URLEndpointRequest::URLRewriter::Cloudinary, Imagekit::Models::Accounts::URLEndpointRequest::URLRewriter::Imgix, Imagekit::Models::Accounts::URLEndpointRequest::URLRewriter::Akamai, nil]
        ...
        # Configuration for third-party URL rewriting.
        #
        # @see Imagekit::Models::Accounts::URLEndpointRequest#url_rewriter
        module URLRewriter
          extend Imagekit::Internal::Type::Union

          discriminator :type

          variant :CLOUDINARY, -> { Imagekit::Accounts::URLEndpointRequest::URLRewriter::Cloudinary }

          variant :IMGIX, -> { Imagekit::Accounts::URLEndpointRequest::URLRewriter::Imgix }

          variant :AKAMAI, -> { Imagekit::Accounts::URLEndpointRequest::URLRewriter::Akamai }
          ...
          #   @return [Array(Imagekit::Models::Accounts::URLEndpointRequest::URLRewriter::Cloudinary, Imagekit::Models::Accounts::URLEndpointRequest::URLRewriter::Imgix, Imagekit::Models::Accounts::URLEndpointRequest::URLRewriter::Akamai)]
        end
      end
    end
  end
