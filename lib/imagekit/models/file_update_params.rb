    ...
    class FileUpdateParams < Imagekit::Internal::Type::BaseModel
      ...
      module Update
        ...
        class UpdateFileDetails < Imagekit::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension>, nil]
          optional :extensions,
          ...
          #   are processed.
          #
          #   @return [Array<String>, Symbol, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::RemoveAITags, nil]
          ...
          #
          #   @param extensions [Array<Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension>] Array of extensions to be applied to the asset. Each extension can be configured
          #
          #   @param remove_ai_tags [Array<String>, Symbol, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::RemoveAITags] An array of AITags associated with the file that you want to remove, e.g. `["car
          #
          ...
          module Extension
            ...
            variant -> { Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension }

            variant -> { Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension }

            variant -> { Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension }

            class RemovedotBgExtension < Imagekit::Internal::Type::BaseModel
              # @!attribute name
              #   Specifies the background removal extension.
              #
              #   @return [Symbol, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Name]
              required :name,
                       enum: -> { Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Name }

              # @!attribute options
              #
              #   @return [Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Options, nil]
              optional :options,
                       -> { Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Options }

              # @!method initialize(name:, options: nil)
              #   @param name [Symbol, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Name] Specifies the background removal extension.
              #
              #   @param options [Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Options]

              # Specifies the background removal extension.
              #
              # @see Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension#name
              module Name
              ...
              # @see Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension#options
              class Options < Imagekit::Internal::Type::BaseModel
                ...
                #   Some parameter documentations has been truncated, see
                #   {Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Options}
                #   for more details.
                #
            ...
            class AutoDescriptionExtension < Imagekit::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension::Name]
              required :name,
                       enum: -> { Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension::Name }

              # @!method initialize(name:)
              #   @param name [Symbol, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension::Name] Specifies the auto description extension.

              # Specifies the auto description extension.
              #
              # @see Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension#name
              module Name
                extend Imagekit::Internal::Type::Enum
            ...
            #   @return [Array(Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension, Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension)]
          end
          ...
          module RemoveAITags
            ...
            variant const: -> { Imagekit::Models::FileUpdateParams::Update::UpdateFileDetails::RemoveAITags::ALL }

            # @!method self.variants
            #   @return [Array(Array<String>, Symbol)]

            define_sorbet_constant!(:Variants) do
              T.type_alias { T.any(T::Array[String], Imagekit::FileUpdateParams::Update::UpdateFileDetails::RemoveAITags::TaggedSymbol) }
            end
