...
module Imagekit
  module Models
    ...
    class File < Imagekit::Internal::Type::BaseModel
      ...
      #
      #   @return [Hash{Symbol=>Imagekit::Models::File::SelectedFieldsSchema}, nil]
      optional :selected_fields_schema,
               -> { Imagekit::Internal::Type::HashOf[Imagekit::File::SelectedFieldsSchema] },
      ...
      #
      #   @param selected_fields_schema [Hash{Symbol=>Imagekit::Models::File::SelectedFieldsSchema}] This field is included in the response only if the Path policy feature is availa
      #
      ...
      class SelectedFieldsSchema < Imagekit::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Imagekit::Models::File::SelectedFieldsSchema::Type]
        required :type, enum: -> { Imagekit::File::SelectedFieldsSchema::Type }
        ...
        optional :default_value,
                 union: -> { Imagekit::File::SelectedFieldsSchema::DefaultValue },
        ...
        optional :max_value, union: -> { Imagekit::File::SelectedFieldsSchema::MaxValue }, api_name: :maxValue
        ...
        #
        #   @return [String, Float, nil]
        optional :min_value, union: -> { Imagekit::File::SelectedFieldsSchema::MinValue }, api_name: :minValue
        ...
        optional :select_options,
                 -> {
                   Imagekit::Internal::Type::ArrayOf[union: Imagekit::File::SelectedFieldsSchema::SelectOption]
                 },
        ...
        #   Some parameter documentations has been truncated, see
        #   {Imagekit::Models::File::SelectedFieldsSchema} for more details.
        #
        #   @param type [Symbol, Imagekit::Models::File::SelectedFieldsSchema::Type] Type of the custom metadata field.
        #
        ...
        # Type of the custom metadata field.
        #
        # @see Imagekit::Models::File::SelectedFieldsSchema#type
        module Type
        ...
        # `type` of custom metadata field.
        #
        # @see Imagekit::Models::File::SelectedFieldsSchema#default_value
        module DefaultValue
          ...
          variant -> { Imagekit::Models::File::SelectedFieldsSchema::DefaultValue::MixedArray }
          ...
          MixedArray =
            Imagekit::Internal::Type::ArrayOf[union: -> {
              Imagekit::File::SelectedFieldsSchema::DefaultValue::Mixed
            }]
        end
        ...
        # field, it will be a numeric value.
        #
        # @see Imagekit::Models::File::SelectedFieldsSchema#max_value
        module MaxValue
          extend Imagekit::Internal::Type::Union
        ...
        # field, it will be a numeric value.
        #
        # @see Imagekit::Models::File::SelectedFieldsSchema#min_value
        module MinValue
          extend Imagekit::Internal::Type::Union
