    ...
    class CustomMetadataFieldUpdateResponse < Imagekit::Internal::Type::BaseModel
      ...
      class Schema < Imagekit::Internal::Type::BaseModel
        ...
        module DefaultValue
          ...
          variant union: -> { Imagekit::Models::CustomMetadataFieldUpdateResponse::Schema::DefaultValue::UnionMember0 }

          variant -> { Imagekit::Models::CustomMetadataFieldUpdateResponse::Schema::DefaultValue::JsonScalar2DArray }
          ...
          JsonScalar2DArray =
            Imagekit::Internal::Type::ArrayOf[union: -> { Imagekit::Models::CustomMetadataFieldUpdateResponse::Schema::DefaultValue::JsonScalarArray }]
        end
