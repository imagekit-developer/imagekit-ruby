...
module Imagekit
  module Models
    class FileListResponseItem < Imagekit::Internal::Type::BaseModel
      # @!attribute ai_tags
      #   An array of tags assigned to the file by auto tagging.
      #
      #   @return [Array<Imagekit::Models::FileListResponseItem::AITag>, nil]
      optional :ai_tags,
               -> { Imagekit::Internal::Type::ArrayOf[Imagekit::Models::FileListResponseItem::AITag] },
               api_name: :AITags,
               nil?: true
      ...
      #
      #   @return [Imagekit::Models::FileListResponseItem::VersionInfo, nil]
      optional :version_info, -> { Imagekit::Models::FileListResponseItem::VersionInfo }, api_name: :versionInfo
      ...
      #   {Imagekit::Models::FileListResponseItem} for more details.
      #
      #   Object containing details of a file or file version.
      #
      #   @param ai_tags [Array<Imagekit::Models::FileListResponseItem::AITag>, nil] An array of tags assigned to the file by auto tagging.
      #
      ...
      #
      #   @param version_info [Imagekit::Models::FileListResponseItem::VersionInfo] An object with details of the file version.
      #
      ...
      class AITag < Imagekit::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Imagekit::Models::FileListResponseItem::AITag} for more details.
        #
      ...
      # @see Imagekit::Models::FileListResponseItem#version_info
    ...
    FileListResponse = Imagekit::Internal::Type::ArrayOf[-> { Imagekit::Models::FileListResponseItem }]
  end
end
