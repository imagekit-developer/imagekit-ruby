...
module Imagekit
  module Models
    class TextOverlay < Imagekit::Models::BaseOverlay
      ...
      # @!attribute type
      #
      #   @return [Symbol, Imagekit::Models::TextOverlay::Type]
      required :type, enum: -> { Imagekit::TextOverlay::Type }
      ...
      # @!method initialize(text:, type:, encoding: nil, transformation: nil)
      ...
      #
      #   @param type [Symbol, Imagekit::Models::TextOverlay::Type]
      #
      ...
      #
      #   @param transformation [Array<Imagekit::Models::TextOverlayTransformation>] Control styling of the text overlay.
