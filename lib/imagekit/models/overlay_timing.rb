...
module Imagekit
  module Models
    class OverlayTiming < Imagekit::Internal::Type::BaseModel
      ...
      optional :duration, union: -> { Imagekit::OverlayTiming::Duration }
      ...
      #
      #   @return [Float, String, nil]
      optional :end_, union: -> { Imagekit::OverlayTiming::End }, api_name: :end
      ...
      #
      #   @return [Float, String, nil]
      optional :start, union: -> { Imagekit::OverlayTiming::Start }

      # @!method initialize(duration: nil, end_: nil, start: nil)
      #   Some parameter documentations has been truncated, see
      #   {Imagekit::Models::OverlayTiming} for more details.
      #
      ...
      # Applies only if the base asset is a video. Maps to `ldu` in the URL.
      #
      # @see Imagekit::Models::OverlayTiming#duration
      module Duration
      ...
      # the base asset is a video. Maps to `leo` in the URL.
      #
      # @see Imagekit::Models::OverlayTiming#end_
      module End
        extend Imagekit::Internal::Type::Union
      ...
      # Applies only if the base asset is a video. Maps to `lso` in the URL.
      #
      # @see Imagekit::Models::OverlayTiming#start
      module Start
        extend Imagekit::Internal::Type::Union
