...
module Imagekit
  module Models
    ...
    class CustomMetadataFieldCreateResponse < Imagekit::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Imagekit::Models::CustomMetadataFieldCreateResponse::Schema]
      required :schema, -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema }

      # @!method initialize(id:, label:, name:, schema:)
      #   Some parameter documentations has been truncated, see
      #   {Imagekit::Models::CustomMetadataFieldCreateResponse} for more details.
      #
      ...
      #
      #   @param schema [Imagekit::Models::CustomMetadataFieldCreateResponse::Schema] An object that describes the rules for the custom metadata field value.

      # @see Imagekit::Models::CustomMetadataFieldCreateResponse#schema
      class Schema < Imagekit::Internal::Type::BaseModel
        # @!attribute type
        #   Type of the custom metadata field.
        #
        #   @return [Symbol, Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::Type]
        required :type, enum: -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::Type }
        ...
        optional :default_value,
                 union: -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue },
        ...
        optional :max_value,
                 union: -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::MaxValue },
                 api_name: :maxValue
        ...
        #   @return [String, Float, nil]
        optional :min_value,
                 union: -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::MinValue },
                 api_name: :minValue
        ...
        optional :select_options,
                 -> { Imagekit::Internal::Type::ArrayOf[union: Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::SelectOption] },
        ...
        #   Some parameter documentations has been truncated, see
        #   {Imagekit::Models::CustomMetadataFieldCreateResponse::Schema} for more details.
        #
        #   An object that describes the rules for the custom metadata field value.
        #
        #   @param type [Symbol, Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::Type] Type of the custom metadata field.
        #
        ...
        # Type of the custom metadata field.
        #
        # @see Imagekit::Models::CustomMetadataFieldCreateResponse::Schema#type
        module Type
        ...
        # depends on the field type.
        #
        # @see Imagekit::Models::CustomMetadataFieldCreateResponse::Schema#default_value
        module DefaultValue
          extend Imagekit::Internal::Type::Union

          # Primitive JSON scalar.
          variant union: -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::UnionMember0 }

          variant -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::JsonScalar2DArray }
          ...
          JsonScalar2DArray =
            Imagekit::Internal::Type::ArrayOf[union: -> { Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::JsonScalarArray }]
        end
        ...
        # field, it will be a numeric value.
        #
        # @see Imagekit::Models::CustomMetadataFieldCreateResponse::Schema#max_value
        module MaxValue
          extend Imagekit::Internal::Type::Union
        ...
        # field, it will be a numeric value.
        #
        # @see Imagekit::Models::CustomMetadataFieldCreateResponse::Schema#min_value
        module MinValue
          extend Imagekit::Internal::Type::Union
