  ...
  module Models
    module Files
      ...
      class VersionRestoreResponse < Imagekit::Internal::Type::BaseModel
        ...
        #   Type of the asset.
        #
        #   @return [Symbol, Imagekit::Models::Files::VersionRestoreResponse::Type, nil]
        optional :type, enum: -> { Imagekit::Models::Files::VersionRestoreResponse::Type }
        ...
        # Type of the asset.
        #
        # @see Imagekit::Models::Files::VersionRestoreResponse#type
        module Type
