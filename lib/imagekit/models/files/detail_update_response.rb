...
module Imagekit
  module Models
    module Files
      ...
      class DetailUpdateResponse < Imagekit::Internal::Type::BaseModel
        # @!attribute ai_tags
        #   An array of tags assigned to the file by auto tagging.
        #
        #   @return [Array<Imagekit::Models::Files::DetailUpdateResponse::AITag>, nil]
        optional :ai_tags,
                 -> { Imagekit::Internal::Type::ArrayOf[Imagekit::Models::Files::DetailUpdateResponse::AITag] },
                 api_name: :AITags,
                 nil?: true
        ...
        #
        #   @return [Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus, nil]
        optional :extension_status,
                 -> { Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus },
        ...
        #
        #   @return [Imagekit::Models::Files::DetailUpdateResponse::VersionInfo, nil]
        optional :version_info,
                 -> { Imagekit::Models::Files::DetailUpdateResponse::VersionInfo },
        ...
        #   {Imagekit::Models::Files::DetailUpdateResponse} for more details.
        #
        #   @param ai_tags [Array<Imagekit::Models::Files::DetailUpdateResponse::AITag>, nil] An array of tags assigned to the file by auto tagging.
        #
        ...
        #
        #   @param extension_status [Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus]
        #
        ...
        #
        #   @param version_info [Imagekit::Models::Files::DetailUpdateResponse::VersionInfo] An object with details of the file version.
        #
        ...
        class AITag < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Files::DetailUpdateResponse::AITag} for more details.
          #
        ...
        # @see Imagekit::Models::Files::DetailUpdateResponse#extension_status
        class ExtensionStatus < Imagekit::Internal::Type::BaseModel
          # @!attribute aws_auto_tagging
          #
          #   @return [Symbol, Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::AwsAutoTagging, nil]
          optional :aws_auto_tagging,
                   enum: -> { Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::AwsAutoTagging },
                   api_name: :"aws-auto-tagging"

          # @!attribute google_auto_tagging
          #
          #   @return [Symbol, Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::GoogleAutoTagging, nil]
          optional :google_auto_tagging,
                   enum: -> { Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::GoogleAutoTagging },
                   api_name: :"google-auto-tagging"

          # @!attribute remove_bg
          #
          #   @return [Symbol, Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::RemoveBg, nil]
          optional :remove_bg,
                   enum: -> { Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::RemoveBg },
                   api_name: :"remove-bg"

          # @!method initialize(aws_auto_tagging: nil, google_auto_tagging: nil, remove_bg: nil)
          #   @param aws_auto_tagging [Symbol, Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::AwsAutoTagging]
          #   @param google_auto_tagging [Symbol, Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::GoogleAutoTagging]
          #   @param remove_bg [Symbol, Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::RemoveBg]

          # @see Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus#aws_auto_tagging
          ...
          # @see Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus#google_auto_tagging
          ...
          # @see Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus#remove_bg
          module RemoveBg
            extend Imagekit::Internal::Type::Enum
        ...
        # @see Imagekit::Models::Files::DetailUpdateResponse#version_info
