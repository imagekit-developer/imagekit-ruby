  ...
  module Models
    module Files
      ...
      class MetadataGetResponse < Imagekit::Internal::Type::BaseModel
        ...
        # @!attribute exif
        #
        #   @return [Imagekit::Models::Files::MetadataGetResponse::Exif, nil]
        optional :exif, -> { Imagekit::Models::Files::MetadataGetResponse::Exif }
        ...
        #
        #   @param exif [Imagekit::Models::Files::MetadataGetResponse::Exif]
        #
        ...
        # @see Imagekit::Models::Files::MetadataGetResponse#exif
