  ...
  module Models
    module Files
      ...
      class MetadataFromURLResponse < Imagekit::Internal::Type::BaseModel
        ...
        # @!attribute exif
        #
        #   @return [Imagekit::Models::Files::MetadataFromURLResponse::Exif, nil]
        optional :exif, -> { Imagekit::Models::Files::MetadataFromURLResponse::Exif }
        ...
        #
        #   @param exif [Imagekit::Models::Files::MetadataFromURLResponse::Exif]
        #
        ...
        # @see Imagekit::Models::Files::MetadataFromURLResponse#exif
