...
module Imagekit
  module Models
    module Files
      # @see Imagekit::Resources::Files::Details#update
      class DetailUpdateParams < Imagekit::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension, Imagekit::Models::Files::DetailUpdateParams::Extension::AutoTaggingExtension>, nil]
        optional :extensions,
                 -> {
                   Imagekit::Internal::Type::ArrayOf[union: Imagekit::Files::DetailUpdateParams::Extension]
                 }
        ...
        #   are processed.
        #
        #   @return [Array<String>, Symbol, Imagekit::Models::Files::DetailUpdateParams::RemoveAITags, nil]
        optional :remove_ai_tags,
                 union: -> { Imagekit::Files::DetailUpdateParams::RemoveAITags },
        ...
        #
        #   @return [Imagekit::Models::Files::DetailUpdateParams::Publish, nil]
        optional :publish, -> { Imagekit::Files::DetailUpdateParams::Publish }

        # @!method initialize(custom_coordinates: nil, custom_metadata: nil, extensions: nil, remove_ai_tags: nil, tags: nil, webhook_url: nil, publish: nil, request_options: {})
        ...
        module Extension
          ...
          variant -> { Imagekit::Files::DetailUpdateParams::Extension::RemovedotBgExtension }

          variant -> { Imagekit::Files::DetailUpdateParams::Extension::AutoTaggingExtension }

          class RemovedotBgExtension < Imagekit::Internal::Type::BaseModel
            # @!attribute name
            #   Specifies the background removal extension.
            #
            #   @return [Symbol, Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Name]
            required :name,
                     enum: -> {
                       Imagekit::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Name
                     }

            # @!attribute options
            #
            #   @return [Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Options, nil]
            optional :options,
                     -> {
                       Imagekit::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Options
                     }

            # @!method initialize(name:, options: nil)
            #   @param name [Symbol, Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Name] Specifies the background removal extension.
            #
            #   @param options [Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Options]

            # Specifies the background removal extension.
            #
            # @see Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension#name
            module Name
            ...
            # @see Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension#options
            class Options < Imagekit::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Options}
              #   for more details.
              #
          ...
          class AutoTaggingExtension < Imagekit::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Imagekit::Models::Files::DetailUpdateParams::Extension::AutoTaggingExtension::Name]
            required :name,
                     enum: -> {
                       Imagekit::Files::DetailUpdateParams::Extension::AutoTaggingExtension::Name
                     }
            ...
            #
            #   @param name [Symbol, Imagekit::Models::Files::DetailUpdateParams::Extension::AutoTaggingExtension::Name] Specifies the auto-tagging extension used.

            # Specifies the auto-tagging extension used.
            #
            # @see Imagekit::Models::Files::DetailUpdateParams::Extension::AutoTaggingExtension#name
            module Name
              extend Imagekit::Internal::Type::Enum
          ...
          #   @return [Array(Imagekit::Models::Files::DetailUpdateParams::Extension::RemovedotBgExtension, Imagekit::Models::Files::DetailUpdateParams::Extension::AutoTaggingExtension)]
        end
        ...
        module RemoveAITags
          ...
          variant -> { Imagekit::Models::Files::DetailUpdateParams::RemoveAITags::StringArray }

          variant const: -> { Imagekit::Models::Files::DetailUpdateParams::RemoveAITags::ALL }
          ...
          define_sorbet_constant!(:Variants) do
            T.type_alias do
              T.any(T::Array[String], Imagekit::Files::DetailUpdateParams::RemoveAITags::TaggedSymbol)
            end
          end
        ...
        class Publish < Imagekit::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::Files::DetailUpdateParams::Publish} for more details.
          #
          #   Configure the publication status of a file and its versions.
          #
