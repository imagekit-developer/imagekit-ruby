    ...
    class CustomMetadataFieldListResponseItem < Imagekit::Internal::Type::BaseModel
      ...
      class Schema < Imagekit::Internal::Type::BaseModel
        ...
        module DefaultValue
          ...
          variant -> { Imagekit::Models::CustomMetadataFieldListResponseItem::Schema::DefaultValue::MixedArray }
          ...
          MixedArray =
            Imagekit::Internal::Type::ArrayOf[union: -> { Imagekit::Models::CustomMetadataFieldListResponseItem::Schema::DefaultValue::Mixed }]
        end
