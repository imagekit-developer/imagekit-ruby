...
module Imagekit
  module Models
    ...
    module UnsafeUnwrapWebhookEvent
      ...
      variant -> { Imagekit::UploadPreTransformSuccessWebhookEvent }
      ...
      variant -> { Imagekit::UploadPreTransformErrorWebhookEvent }
      ...
      variant -> { Imagekit::UploadPostTransformSuccessWebhookEvent }
      ...
      variant -> { Imagekit::UploadPostTransformErrorWebhookEvent }

      # @!method self.variants
      #   @return [Array(Imagekit::Models::VideoTransformationAcceptedEvent, Imagekit::Models::VideoTransformationReadyEvent, Imagekit::Models::VideoTransformationErrorEvent, Imagekit::Models::UploadPreTransformSuccessWebhookEvent, Imagekit::Models::UploadPreTransformErrorWebhookEvent, Imagekit::Models::UploadPostTransformSuccessWebhookEvent, Imagekit::Models::UploadPostTransformErrorWebhookEvent)]
    end
  end
end
