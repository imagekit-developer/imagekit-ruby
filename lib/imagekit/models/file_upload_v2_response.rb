...
module Imagekit
  module Models
    ...
    class FileUploadV2Response < Imagekit::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Imagekit::Models::FileUploadV2Response::AITag>, nil]
      optional :ai_tags,
               -> { Imagekit::Internal::Type::ArrayOf[Imagekit::Models::FileUploadV2Response::AITag] },
               api_name: :AITags,
               nil?: true
      ...
      #
      #   @return [Imagekit::Models::FileUploadV2Response::EmbeddedMetadata, nil]
      ...
      #
      #   @return [Imagekit::Models::FileUploadV2Response::ExtensionStatus, nil]
      ...
      #
      #   @return [Imagekit::Models::FileUploadV2Response::Metadata, nil]
      optional :metadata, -> { Imagekit::Models::FileUploadV2Response::Metadata }
      ...
      #
      #   @return [Imagekit::Models::FileUploadV2Response::VersionInfo, nil]
      optional :version_info, -> { Imagekit::Models::FileUploadV2Response::VersionInfo }, api_name: :versionInfo
      ...
      #   {Imagekit::Models::FileUploadV2Response} for more details.
      #
      #   Object containing details of a successful upload.
      #
      #   @param ai_tags [Array<Imagekit::Models::FileUploadV2Response::AITag>, nil] An array of tags assigned to the uploaded file by auto tagging.
      #
      ...
      #
      #   @param embedded_metadata [Imagekit::Models::FileUploadV2Response::EmbeddedMetadata] Consolidated embedded metadata associated with the file. It includes exif, iptc,
      #
      #   @param extension_status [Imagekit::Models::FileUploadV2Response::ExtensionStatus] Extension names with their processing status at the time of completion of the re
      #
      ...
      #
      #   @param metadata [Imagekit::Models::FileUploadV2Response::Metadata] Legacy metadata. Send `metadata` in `responseFields` in API request to get metad
      #
      ...
      #
      #   @param version_info [Imagekit::Models::FileUploadV2Response::VersionInfo] An object containing the file or file version's `id` (versionId) and `name`.
      #
      ...
      class AITag < Imagekit::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Imagekit::Models::FileUploadV2Response::AITag} for more details.
        #
      ...
      # @see Imagekit::Models::FileUploadV2Response#embedded_metadata
      ...
      # @see Imagekit::Models::FileUploadV2Response#extension_status
      class ExtensionStatus < Imagekit::Internal::Type::BaseModel
        # @!attribute aws_auto_tagging
        #
        #   @return [Symbol, Imagekit::Models::FileUploadV2Response::ExtensionStatus::AwsAutoTagging, nil]
        optional :aws_auto_tagging,
                 enum: -> { Imagekit::Models::FileUploadV2Response::ExtensionStatus::AwsAutoTagging },
                 api_name: :"aws-auto-tagging"

        # @!attribute google_auto_tagging
        #
        #   @return [Symbol, Imagekit::Models::FileUploadV2Response::ExtensionStatus::GoogleAutoTagging, nil]
        optional :google_auto_tagging,
                 enum: -> { Imagekit::Models::FileUploadV2Response::ExtensionStatus::GoogleAutoTagging },
                 api_name: :"google-auto-tagging"

        # @!attribute remove_bg
        #
        #   @return [Symbol, Imagekit::Models::FileUploadV2Response::ExtensionStatus::RemoveBg, nil]
        optional :remove_bg,
                 enum: -> { Imagekit::Models::FileUploadV2Response::ExtensionStatus::RemoveBg },
                 api_name: :"remove-bg"
        ...
        #   If no extension was requested, then this parameter is not returned.
        #
        #   @param aws_auto_tagging [Symbol, Imagekit::Models::FileUploadV2Response::ExtensionStatus::AwsAutoTagging]
        #   @param google_auto_tagging [Symbol, Imagekit::Models::FileUploadV2Response::ExtensionStatus::GoogleAutoTagging]
        #   @param remove_bg [Symbol, Imagekit::Models::FileUploadV2Response::ExtensionStatus::RemoveBg]

        # @see Imagekit::Models::FileUploadV2Response::ExtensionStatus#aws_auto_tagging
        ...
        # @see Imagekit::Models::FileUploadV2Response::ExtensionStatus#google_auto_tagging
        ...
        # @see Imagekit::Models::FileUploadV2Response::ExtensionStatus#remove_bg
        module RemoveBg
          extend Imagekit::Internal::Type::Enum
      ...
      # @see Imagekit::Models::FileUploadV2Response#metadata
      class Metadata < Imagekit::Internal::Type::BaseModel
        ...
        # @!attribute exif
        #
        #   @return [Imagekit::Models::FileUploadV2Response::Metadata::Exif, nil]
        optional :exif, -> { Imagekit::Models::FileUploadV2Response::Metadata::Exif }
        ...
        #   @param duration [Integer] The duration of the video in seconds (only for video).
        #
        #   @param exif [Imagekit::Models::FileUploadV2Response::Metadata::Exif]
        #
        ...
        # @see Imagekit::Models::FileUploadV2Response::Metadata#exif
      ...
      # @see Imagekit::Models::FileUploadV2Response#version_info
