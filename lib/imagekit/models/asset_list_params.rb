...
module Imagekit
  module Models
    # @see Imagekit::Resources::Assets#list
    class AssetListParams < Imagekit::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Imagekit::Models::AssetListParams::FileType, nil]
      optional :file_type, enum: -> { Imagekit::AssetListParams::FileType }
      ...
      #   order.
      #
      #   @return [Symbol, Imagekit::Models::AssetListParams::Sort, nil]
      optional :sort, enum: -> { Imagekit::AssetListParams::Sort }
      ...
      #
      #   @return [Symbol, Imagekit::Models::AssetListParams::Type, nil]
      optional :type, enum: -> { Imagekit::AssetListParams::Type }
