...
module Imagekit
  module Models
    class Folder < Imagekit::Internal::Type::BaseModel
      ...
      #   Type of the asset.
      #
      #   @return [Symbol, Imagekit::Models::Folder::Type, nil]
      optional :type, enum: -> { Imagekit::Folder::Type }
      ...
      #   Some parameter documentations has been truncated, see {Imagekit::Models::Folder}
      #   for more details.
      #
      ...
      # Type of the asset.
      #
      # @see Imagekit::Models::Folder#type
      module Type
