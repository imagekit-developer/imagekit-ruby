  ...
  module Models
    class UploadPreTransformSuccessEvent < Imagekit::Models::BaseWebhookEvent
      ...
      class Data < Imagekit::Internal::Type::BaseModel
        ...
        #
        #   @return [Hash{Symbol=>Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema}, nil]
        optional :selected_fields_schema,
                 -> {
                   Imagekit::Internal::Type::HashOf[Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema]
                 },
        ...
        #
        #   @param selected_fields_schema [Hash{Symbol=>Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema}] This field is included in the response only if the Path policy feature is availa
        #
        ...
        class SelectedFieldsSchema < Imagekit::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::Type]
          required :type, enum: -> { Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::Type }
          ...
          optional :default_value,
                   union: -> {
                     Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::DefaultValue
                   },
          ...
          optional :max_value,
                   union: -> {
                     Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::MaxValue
                   },
                   api_name: :maxValue
          ...
          optional :min_value,
                   union: -> {
                     Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::MinValue
                   },
                   api_name: :minValue
          ...
          optional :select_options,
                   -> {
                     Imagekit::Internal::Type::ArrayOf[union: Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::SelectOption]
                   },
          ...
          #   Some parameter documentations has been truncated, see
          #   {Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema}
          #   for more details.
          #
          #   @param type [Symbol, Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::Type] Type of the custom metadata field.
          #
          ...
          # Type of the custom metadata field.
          #
          # @see Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema#type
          module Type
            extend Imagekit::Internal::Type::Enum
          ...
          # `type` of custom metadata field.
          #
          # @see Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema#default_value
          module DefaultValue
            ...
            variant -> { Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::DefaultValue::MixedArray }
            ...
            MixedArray =
              Imagekit::Internal::Type::ArrayOf[union: -> {
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::DefaultValue::Mixed
              }]
          end
          ...
          # field, it will be a numeric value.
          #
          # @see Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema#max_value
          module MaxValue
            extend Imagekit::Internal::Type::Union
          ...
          # field, it will be a numeric value.
          #
          # @see Imagekit::Models::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema#min_value
          module MinValue
            extend Imagekit::Internal::Type::Union
