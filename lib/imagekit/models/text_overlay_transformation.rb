...
module Imagekit
  module Models
    class TextOverlayTransformation < Imagekit::Internal::Type::BaseModel
      ...
      #
      #   @return [Float, Symbol, Imagekit::Models::TextOverlayTransformation::Radius, nil]
      ...
      #
      #   @return [Symbol, Imagekit::Models::TextOverlayTransformation::Typography, nil]
      optional :typography, enum: -> { Imagekit::TextOverlayTransformation::Typography }
      ...
      #
      #   @param radius [Float, Symbol, Imagekit::Models::TextOverlayTransformation::Radius] Specifies the corner radius of the text overlay.
      #
      #   @param rotation [Float, String] Specifies the rotation angle of the text overlay.
      #
      #   @param typography [Symbol, Imagekit::Models::TextOverlayTransformation::Typography] Specifies the typography style of the text.
      #
      ...
      module Radius
        ...
        variant const: -> { Imagekit::Models::TextOverlayTransformation::Radius::MAX }

        # @!method self.variants
        #   @return [Array(Float, Symbol)]

        define_sorbet_constant!(:Variants) do
          T.type_alias { T.any(Float, Imagekit::TextOverlayTransformation::Radius::TaggedSymbol) }
        end
      ...
      # for italics, and `b_i` for bold with italics.
      #
      # @see Imagekit::Models::TextOverlayTransformation#typography
      module Typography
        extend Imagekit::Internal::Type::Enum
