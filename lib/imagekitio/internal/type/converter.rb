    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Imagekitio::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Imagekitio::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          # @api private
          #
          # @param spec [Hash{Symbol=>Object}, Proc, Imagekitio::Internal::Type::Converter, Class] .
          #
          ...
          def type_info(spec)
            ...
            in Imagekitio::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Imagekitio::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Imagekitio::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Imagekitio::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Imagekitio::Internal::Type::Converter
              ...
              Imagekitio::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Imagekitio::Internal::Type::Converter, T::Class[T.anything]) }
        end
