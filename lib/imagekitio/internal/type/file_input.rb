...
module Imagekitio
  module Internal
    module Type
      ...
      # `Imagekitio::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Imagekitio::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Imagekitio::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Imagekitio::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Imagekitio::FilePart.new(value, filename: "upload") : value
            in Imagekitio::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
