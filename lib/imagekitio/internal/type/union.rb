  ...
  module Internal
    module Type
      ...
      module Union
        ...
        include Imagekitio::Internal::Util::SorbetRuntimeSupport
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, Imagekitio::Internal::Type::Converter, Class]
        #
        ...
        private def variant(key, spec = nil)
          meta = Imagekitio::Internal::Type::Converter.meta_info(nil, spec)
          variant_info =
            case key
            in Symbol
              [key, Imagekitio::Internal::Type::Converter.type_info(spec), meta]
            in Proc | Imagekitio::Internal::Type::Converter | Class | Hash
              [nil, Imagekitio::Internal::Type::Converter.type_info(key), meta]
            end
        ...
        # @param value [Object]
        #
        # @return [Imagekitio::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          case [@discriminator, value]
          in [_, Imagekitio::Internal::Type::BaseModel]
            value.class
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, Imagekitio::Internal::OMIT)
            end

            return nil if key == Imagekitio::Internal::OMIT
