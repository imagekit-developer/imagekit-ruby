    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<Imagekitio::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          #
          # @param type_info [Hash{Symbol=>Object}, Proc, Imagekitio::Internal::Type::Converter, Class]
          #
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            meta = Imagekitio::Internal::Type::Converter.meta_info(type_info, spec)
            type_fn, info =
              case type_info
              in Proc | Imagekitio::Internal::Type::Converter | Class
                [Imagekitio::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Imagekitio::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, Imagekitio::Internal::OMIT) : Imagekitio::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Imagekitio::Internal::Type::Converter.new_coerce_state(translate_names: false)
              ...
              stored =
                case [target, status]
                in [Imagekitio::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Imagekitio::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Imagekitio::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == Imagekitio::Internal::OMIT ? nil : const }
                  state = Imagekitio::Internal::Type::Converter.new_coerce_state(translate_names: false)
        ...
        class << self
          # @api private
          #
          # @param value [Imagekitio::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = Imagekitio::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == Imagekitio::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Imagekitio::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
          ...
          def dump(value, state:)
            unless (coerced = Imagekitio::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, Imagekitio::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == Imagekitio::Internal::OMIT
        ...
        class << self
          # @api private
          #
          # @param model [Imagekitio::Internal::Type::BaseModel]
        ...
        #
        # @return [String]
        def to_json(*a) = Imagekitio::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = Imagekitio::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          Imagekitio::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                Imagekitio::Internal::Type::Converter.inspect(type, depth: depth),
