  ...
  module Models
    module Accounts
      ...
      class URLEndpointResponse < Imagekitio::Internal::Type::BaseModel
        ...
        #
        #   @return [Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Cloudinary, Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Imgix, Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Akamai, nil]
        ...
        #   {Imagekitio::Models::Accounts::URLEndpointResponse} for more details.
        #
        ...
        #
        #   @param url_rewriter [Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Cloudinary, Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Imgix, Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Akamai] Configuration for third-party URL rewriting.

        # Configuration for third-party URL rewriting.
        #
        # @see Imagekitio::Models::Accounts::URLEndpointResponse#url_rewriter
        module URLRewriter
          extend Imagekitio::Internal::Type::Union

          discriminator :type

          variant :CLOUDINARY, -> { Imagekitio::Accounts::URLEndpointResponse::URLRewriter::Cloudinary }

          variant :IMGIX, -> { Imagekitio::Accounts::URLEndpointResponse::URLRewriter::Imgix }

          variant :AKAMAI, -> { Imagekitio::Accounts::URLEndpointResponse::URLRewriter::Akamai }
          ...
          #   @return [Array(Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Cloudinary, Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Imgix, Imagekitio::Models::Accounts::URLEndpointResponse::URLRewriter::Akamai)]
        end
      end
    end
  end
