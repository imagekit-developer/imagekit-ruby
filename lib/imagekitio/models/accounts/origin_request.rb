  ...
  module Models
    module Accounts
      ...
      module OriginRequest
        ...
        variant :S3, -> { Imagekitio::Accounts::OriginRequest::S3 }

        variant :S3_COMPATIBLE, -> { Imagekitio::Accounts::OriginRequest::S3Compatible }

        variant :CLOUDINARY_BACKUP, -> { Imagekitio::Accounts::OriginRequest::CloudinaryBackup }

        variant :WEB_FOLDER, -> { Imagekitio::Accounts::OriginRequest::WebFolder }

        variant :WEB_PROXY, -> { Imagekitio::Accounts::OriginRequest::WebProxy }

        variant :GCS, -> { Imagekitio::Accounts::OriginRequest::Gcs }

        variant :AZURE_BLOB, -> { Imagekitio::Accounts::OriginRequest::AzureBlob }

        variant :AKENEO_PIM, -> { Imagekitio::Accounts::OriginRequest::AkeneoPim }
        ...
        class S3Compatible < Imagekitio::Internal::Type::BaseModel
          ...
          #
          #   @return [Boolean, nil]
          optional :s3_force_path_style, Imagekitio::Internal::Type::Boolean, api_name: :s3ForcePathStyle
