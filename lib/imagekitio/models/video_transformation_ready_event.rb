...
module Imagekitio
  module Models
    class VideoTransformationReadyEvent < Imagekitio::Models::BaseWebhookEvent
      ...
      # @!attribute data
      #
      #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Data]
      required :data, -> { Imagekitio::VideoTransformationReadyEvent::Data }

      # @!attribute request
      #   Information about the original request that triggered the video transformation.
      #
      #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Request]
      ...
      #
      #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Timings, nil]
      ...
      #
      #   @param data [Imagekitio::Models::VideoTransformationReadyEvent::Data]
      #
      #   @param request [Imagekitio::Models::VideoTransformationReadyEvent::Request] Information about the original request that triggered the video transformation.
      #
      #   @param timings [Imagekitio::Models::VideoTransformationReadyEvent::Timings] Performance metrics for the transformation process.
      #
      ...
      class Data < Imagekitio::Internal::Type::BaseModel
        ...
        #
        #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Data::Asset]
        required :asset, -> { Imagekitio::VideoTransformationReadyEvent::Data::Asset }

        # @!attribute transformation
        #
        #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation]
        required :transformation, -> { Imagekitio::VideoTransformationReadyEvent::Data::Transformation }

        # @!method initialize(asset:, transformation:)
        #   @param asset [Imagekitio::Models::VideoTransformationReadyEvent::Data::Asset] Information about the source video asset being transformed.
        #
        #   @param transformation [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation]

        # @see Imagekitio::Models::VideoTransformationReadyEvent::Data#asset
        ...
        # @see Imagekitio::Models::VideoTransformationReadyEvent::Data#transformation
        class Transformation < Imagekitio::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Type]
          required :type, enum: -> { Imagekitio::VideoTransformationReadyEvent::Data::Transformation::Type }

          # @!attribute options
          #   Configuration options for video transformations.
          #
          #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options, nil]
          optional :options, -> { Imagekitio::VideoTransformationReadyEvent::Data::Transformation::Options }

          # @!attribute output
          #   Information about the transformed output video.
          #
          #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Output, nil]
          optional :output, -> { Imagekitio::VideoTransformationReadyEvent::Data::Transformation::Output }

          # @!method initialize(type:, options: nil, output: nil)
          #   Some parameter documentations has been truncated, see
          #   {Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation} for
          #   more details.
          #
          #   @param type [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Type] Type of video transformation:
          #
          #   @param options [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options] Configuration options for video transformations.
          #
          #   @param output [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Output] Information about the transformed output video.
          ...
          # - `video-thumbnail`: Generate thumbnail image from video
          #
          # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation#type
          module Type
          ...
          # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation#options
          class Options < Imagekitio::Internal::Type::BaseModel
            # @!attribute audio_codec
            #   Audio codec used for encoding (aac or opus).
            #
            #   @return [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::AudioCodec, nil]
            ...
            #
            #   @return [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::Format, nil]
            optional :format_,
                     enum: -> {
            ...
            #
            #   @return [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::StreamProtocol, nil]
            ...
            #
            #   @return [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::VideoCodec, nil]
            ...
            #   Configuration options for video transformations.
            #
            #   @param audio_codec [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::AudioCodec] Audio codec used for encoding (aac or opus).
            #
            #   @param auto_rotate [Boolean] Whether to automatically rotate the video based on metadata.
            #
            #   @param format_ [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::Format] Output format for the transformed video or thumbnail.
            #
            #   @param quality [Integer] Quality setting for the output video.
            #
            #   @param stream_protocol [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::StreamProtocol] Streaming protocol for adaptive bitrate streaming.
            #
            #   @param variants [Array<String>] Array of quality representations for adaptive bitrate streaming.
            #
            #   @param video_codec [Symbol, Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options::VideoCodec] Video codec used for encoding (h264, vp9, or av1).

            # Audio codec used for encoding (aac or opus).
            #
            # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options#audio_codec
            module AudioCodec
              extend Imagekitio::Internal::Type::Enum
            ...
            # Output format for the transformed video or thumbnail.
            #
            # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options#format_
            module Format
              extend Imagekitio::Internal::Type::Enum
            ...
            # Streaming protocol for adaptive bitrate streaming.
            #
            # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options#stream_protocol
            ...
            # Video codec used for encoding (h264, vp9, or av1).
            #
            # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Options#video_codec
            module VideoCodec
              extend Imagekitio::Internal::Type::Enum
          ...
          # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation#output
          class Output < Imagekitio::Internal::Type::BaseModel
            ...
            #
            #   @return [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Output::VideoMetadata, nil]
            ...
            #
            #   @param video_metadata [Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Output::VideoMetadata] Metadata of the output video file.

            # @see Imagekitio::Models::VideoTransformationReadyEvent::Data::Transformation::Output#video_metadata
