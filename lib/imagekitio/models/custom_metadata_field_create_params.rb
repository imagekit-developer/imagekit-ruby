  ...
  module Models
    ...
    class CustomMetadataFieldCreateParams < Imagekitio::Internal::Type::BaseModel
      ...
      class Schema < Imagekitio::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Imagekitio::Models::CustomMetadataFieldCreateParams::Schema::Type, nil]
        optional :type, enum: -> { Imagekitio::CustomMetadataFieldCreateParams::Schema::Type }

        # @!method initialize(default_value: nil, is_value_required: nil, max_length: nil, max_value: nil, min_length: nil, min_value: nil, select_options: nil, type: nil)
        #   Some parameter documentations has been truncated, see
