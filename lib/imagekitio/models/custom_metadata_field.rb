  ...
  module Models
    ...
    class CustomMetadataField < Imagekitio::Internal::Type::BaseModel
      ...
      class Schema < Imagekitio::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Imagekitio::Models::CustomMetadataField::Schema::Type]
        ...
        #   An object that describes the rules for the custom metadata field value.
        #
        #   @param type [Symbol, Imagekitio::Models::CustomMetadataField::Schema::Type] Type of the custom metadata field.
        #
        ...
        # Type of the custom metadata field.
        #
        # @see Imagekitio::Models::CustomMetadataField::Schema#type
        module Type
        ...
        # depends on the field type.
        #
        # @see Imagekitio::Models::CustomMetadataField::Schema#default_value
        module DefaultValue
          ...
          variant -> { Imagekitio::Models::CustomMetadataField::Schema::DefaultValue::MixedArray }
        ...
        # field, it will be a numeric value.
        #
        # @see Imagekitio::Models::CustomMetadataField::Schema#max_value
        module MaxValue
          extend Imagekitio::Internal::Type::Union
        ...
        # field, it will be a numeric value.
        #
        # @see Imagekitio::Models::CustomMetadataField::Schema#min_value
        module MinValue
          extend Imagekitio::Internal::Type::Union
