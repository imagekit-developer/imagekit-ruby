...
module Imagekitio
  module Models
    ...
    class FileUploadParams < Imagekitio::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Symbol, Imagekitio::Models::FileUploadParams::ResponseField>, nil]
      optional :response_fields,
               -> { Imagekitio::Internal::Type::ArrayOf[enum: Imagekitio::FileUploadParams::ResponseField] },
      ...
      #
      #   @return [Imagekitio::Models::FileUploadParams::Transformation, nil]
      optional :transformation, -> { Imagekitio::FileUploadParams::Transformation }
      ...
      class Transformation < Imagekitio::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Imagekitio::Models::FileUploadParams::Transformation::Post::Transformation, Imagekitio::Models::FileUploadParams::Transformation::Post::GifToVideo, Imagekitio::Models::FileUploadParams::Transformation::Post::Thumbnail, Imagekitio::Models::FileUploadParams::Transformation::Post::Abs>, nil]
        optional :post,
                 -> { Imagekitio::Internal::Type::ArrayOf[union: Imagekitio::FileUploadParams::Transformation::Post] }
        ...
        #   You can mix and match any combination of post-processing types.
        #
        #   @param post [Array<Imagekitio::Models::FileUploadParams::Transformation::Post::Transformation, Imagekitio::Models::FileUploadParams::Transformation::Post::GifToVideo, Imagekitio::Models::FileUploadParams::Transformation::Post::Thumbnail, Imagekitio::Models::FileUploadParams::Transformation::Post::Abs>] List of transformations to apply _after_ the file is uploaded.
        #
        ...
        module Post
          ...
          variant :transformation, -> { Imagekitio::FileUploadParams::Transformation::Post::Transformation }

          variant :"gif-to-video", -> { Imagekitio::FileUploadParams::Transformation::Post::GifToVideo }

          variant :thumbnail, -> { Imagekitio::FileUploadParams::Transformation::Post::Thumbnail }

          variant :abs, -> { Imagekitio::FileUploadParams::Transformation::Post::Abs }
          ...
          class Transformation < Imagekitio::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Imagekitio::Models::FileUploadParams::Transformation::Post::Transformation} for
            #   more details.
            #
          ...
          class GifToVideo < Imagekitio::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Imagekitio::Models::FileUploadParams::Transformation::Post::GifToVideo} for
            #   more details.
            #
          ...
          class Thumbnail < Imagekitio::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Imagekitio::Models::FileUploadParams::Transformation::Post::Thumbnail} for more
            #   details.
            #
          ...
          class Abs < Imagekitio::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Imagekitio::Models::FileUploadParams::Transformation::Post::Abs::Protocol]
            required :protocol, enum: -> { Imagekitio::FileUploadParams::Transformation::Post::Abs::Protocol }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Imagekitio::Models::FileUploadParams::Transformation::Post::Abs} for more
            #   details.
            #
            #   @param protocol [Symbol, Imagekitio::Models::FileUploadParams::Transformation::Post::Abs::Protocol] Streaming protocol to use (`hls` or `dash`).
            #
            ...
            # Streaming protocol to use (`hls` or `dash`).
            #
            # @see Imagekitio::Models::FileUploadParams::Transformation::Post::Abs#protocol
            module Protocol
              extend Imagekitio::Internal::Type::Enum
          ...
          #   @return [Array(Imagekitio::Models::FileUploadParams::Transformation::Post::Transformation, Imagekitio::Models::FileUploadParams::Transformation::Post::GifToVideo, Imagekitio::Models::FileUploadParams::Transformation::Post::Thumbnail, Imagekitio::Models::FileUploadParams::Transformation::Post::Abs)]
        end
      end
    end
  end
