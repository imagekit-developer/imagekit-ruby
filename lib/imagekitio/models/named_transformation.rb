...
module Imagekitio
  module Models
    class NamedTransformation < Imagekitio::Internal::Type::BaseModel
      ...
      #
      #   @param created_at [Time] Timestamp (ISO string) when the named transformation was created.
      #
      #   @param enabled [Boolean] Whether this named transformation is currently enabled.
      #
      #   @param name [String] Name of the named transformation, used as `tr:n-<name>` in image and video URLs.
      #
      #   @param transformation [String] The transformation this name refers to. Always returned with the `tr:` prefix in
    end
  end
end
