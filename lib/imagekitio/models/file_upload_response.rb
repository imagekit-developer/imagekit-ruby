...
module Imagekitio
  module Models
    ...
    class FileUploadResponse < Imagekitio::Internal::Type::BaseModel
      ...
      #
      #   @return [Imagekitio::Models::FileUploadResponse::ExtensionStatus, nil]
      ...
      #
      #   @param extension_status [Imagekitio::Models::FileUploadResponse::ExtensionStatus] Extension names with their processing status at the time of completion of the re
      #
      ...
      class ExtensionStatus < Imagekitio::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Imagekitio::Models::FileUploadResponse::ExtensionStatus::AIAutoDescription, nil]
        ...
        #
        #   @return [Symbol, Imagekitio::Models::FileUploadResponse::ExtensionStatus::GoogleAutoTagging, nil]
        optional :google_auto_tagging,
                 enum: -> { Imagekitio::Models::FileUploadResponse::ExtensionStatus::GoogleAutoTagging },
                 api_name: :"google-auto-tagging"

        # @!attribute remove_bg
        #
        #   @return [Symbol, Imagekitio::Models::FileUploadResponse::ExtensionStatus::RemoveBg, nil]
        optional :remove_bg,
        ...
        # @see Imagekitio::Models::FileUploadResponse::ExtensionStatus#remove_bg
        module RemoveBg
          extend Imagekitio::Internal::Type::Enum
