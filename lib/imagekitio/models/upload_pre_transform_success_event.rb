...
module Imagekitio
  module Models
    class UploadPreTransformSuccessEvent < Imagekitio::Models::BaseWebhookEvent
      ...
      #
      #   @return [Imagekitio::Models::UploadPreTransformSuccessEvent::Data]
      required :data, -> { Imagekitio::UploadPreTransformSuccessEvent::Data }

      # @!attribute request
      #
      #   @return [Imagekitio::Models::UploadPreTransformSuccessEvent::Request]
      required :request, -> { Imagekitio::UploadPreTransformSuccessEvent::Request }
      ...
      #
      #   @param data [Imagekitio::Models::UploadPreTransformSuccessEvent::Data] Object containing details of a successful upload.
      #
      #   @param request [Imagekitio::Models::UploadPreTransformSuccessEvent::Request]
      #
