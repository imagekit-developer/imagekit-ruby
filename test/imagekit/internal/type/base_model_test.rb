...
class Imagekit::Test::PrimitiveModelTest < Minitest::Test
  A = Imagekit::Internal::Type::ArrayOf[-> { Integer }]
  H = Imagekit::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Imagekit::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Imagekit::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Imagekit::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Imagekit::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Imagekit::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Imagekit::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Imagekit::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Imagekit::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Imagekit::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Imagekit::Internal::Type::Boolean, true] => true,
      [Imagekit::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Imagekit::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Imagekit::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Imagekit::Internal::Type::Converter.new_coerce_state
      Imagekit::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Imagekit::Internal::Type::Converter.dump(target, input, state: state)
...
class Imagekit::Test::EnumModelTest < Minitest::Test
  class E0
    include Imagekit::Internal::Type::Enum
    attr_reader :values
...
class Imagekit::Test::CollectionModelTest < Minitest::Test
  A1 = Imagekit::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Imagekit::Internal::Type::HashOf[Integer]

  A2 = Imagekit::Internal::Type::ArrayOf[H1]
  H2 = Imagekit::Internal::Type::HashOf[-> { A1 }]

  A3 = Imagekit::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Imagekit::Internal::Type::HashOf[Integer, nil?: true]
...
class Imagekit::Test::BaseModelTest < Minitest::Test
  class M1 < Imagekit::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Imagekit::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Imagekit::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Imagekit::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Imagekit::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Imagekit::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Imagekit::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Imagekit::Errors::ConversionError => e
...
class Imagekit::Test::UnionTest < Minitest::Test
  class U0
    include Imagekit::Internal::Type::Union
  ...
  class M2 < Imagekit::Internal::Type::BaseModel
  ...
  class M4 < Imagekit::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Imagekit::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Imagekit::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Imagekit::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Imagekit::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Imagekit::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [Imagekit::Internal::Type::Unknown, Imagekit::Internal::Type::Unknown] => true,
      [Imagekit::Internal::Type::Boolean, Imagekit::Internal::Type::Boolean] => true,
      [Imagekit::Internal::Type::Unknown, Imagekit::Internal::Type::Boolean] => false,
...
class Imagekit::Test::MetaInfoTest < Minitest::Test
  A1 = Imagekit::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Imagekit::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
