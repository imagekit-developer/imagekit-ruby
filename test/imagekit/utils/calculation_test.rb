...
RSpec.describe ImageKitIo::Utils::Calculation do
  let(:subject) { described_class }

  it "is_valid_hex_with_valid_hex" do
    result = subject.is_valid_hex('f06830ca9f1e3e90')
  ...
  it "hamming_distance_test_expect_0" do
    result = subject.hamming_distance('f06830ca9f1e3e90', 'f06830ca9f1e3e90')
    expect(0).to eq(result)
  end

  it "hamming_distance_test_expect_17" do
    result = subject.hamming_distance('2d5ad3936d2e015b', '2d6ed293db36a4fb')
    expect(17).to eq(result)
  end

  it "hamming_distance_test_expect_37" do
    result = subject.hamming_distance('a4a65595ac94518b', '7838873e791f8400')
  ...
  it "get_authenticated_params_test_with_nil_expire_nill_token" do
    ...
    result = subject.get_authenticated_params(nil, nil, 'private_key')
  ...
  it "get_authenticated_params_test_with_nil_expire" do
    allow(OpenSSL::HMAC).to receive(:hexdigest).and_return('my_signature')
    result = subject.get_authenticated_params('my_token', nil, 'private_key')
  ...
  it "get_authenticated_params_test_with_hard_coded_params" do
    result = subject.get_authenticated_params('your_token', 1582269249, 'private_key_test')
  ...
  it "get_authenticated_params_test_with_nil_private_key" do
    allow(OpenSSL::HMAC).to receive(:hexdigest).and_return('my_signature')
    result = subject.get_authenticated_params('your_token', 1582269249, nil)
