...
class OverlayTest < Minitest::Test
  ...
  def test_should_ignore_image_overlay_when_input_property_is_missing
    transformation = [
      Imagekit::Models::Transformation.new(
        overlay: Imagekit::Models::ImageOverlay.new(
          input: ""
        )
      )
    ]
  ...
  def test_should_ignore_video_overlay_when_input_property_is_missing
    transformation = [
      Imagekit::Models::Transformation.new(
        overlay: Imagekit::Models::VideoOverlay.new(
          input: ""
        )
      )
    ]
  ...
  def test_should_ignore_subtitle_overlay_when_input_property_is_missing
    transformation = [
      Imagekit::Models::Transformation.new(
        overlay: Imagekit::Models::SubtitleOverlay.new(
          input: ""
        )
      )
    ]
  ...
  def test_should_ignore_solid_color_overlay_when_color_property_is_missing
    transformation = [
      Imagekit::Models::Transformation.new(
        overlay: Imagekit::Models::SolidColorOverlay.new(
          color: ""
        )
      )
    ]
  ...
  def test_should_generate_url_with_multiple_complex_overlays_including_nested_transformations
    transformation = [
      ...
      Imagekit::Models::Transformation.new(
        overlay: Imagekit::Models::TextOverlay.new(
          text: "Every thing",
          position: Imagekit::Models::OverlayPosition.new(
            x: "10",
            y_: "20",
            focus: :center
          ),
          timing: Imagekit::Models::OverlayTiming.new(
            start: 5.0,
            duration: "10",
            end_: 15.0
          ),
          transformation: [
            Imagekit::Models::TextOverlayTransformation.new(
              width: "bw_mul_0.5",
              font_size: 20.0,
              font_family: "Arial",
              font_color: "0000ff",
      ...
      Imagekit::Models::Transformation.new(
        overlay: Imagekit::Models::SubtitleOverlay.new(
          ...
          transformation: [
            Imagekit::Models::SubtitleOverlayTransformation.new(
              background: "red",
              color: "0000ff",
              font_family: "Arial",
      ...
      Imagekit::Models::Transformation.new(
        overlay: Imagekit::Models::SolidColorOverlay.new(
          ...
          transformation: [
            Imagekit::Models::SolidColorOverlayTransformation.new(
              width: "bw_mul_0.5",
              height: "bh_mul_0.5",
              alpha: 0.5,
              background: "red",
