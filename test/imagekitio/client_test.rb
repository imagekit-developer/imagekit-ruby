...
class ImagekitioTest < Minitest::Test
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Imagekitio::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Imagekitio::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
