...
class Imagekitio::Test::SingletonClient < Imagekitio::Client
  include Singleton
...
class Imagekitio::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @image_kit = Imagekitio::Test::SingletonClient.instance
  end
