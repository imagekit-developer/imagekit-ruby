...
class Imagekitio::Test::PrimitiveModelTest < Minitest::Test
  A = Imagekitio::Internal::Type::ArrayOf[-> { Integer }]
  H = Imagekitio::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Imagekitio::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Imagekitio::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Imagekitio::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Imagekitio::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Imagekitio::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Imagekitio::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Imagekitio::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Imagekitio::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Imagekitio::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Imagekitio::Internal::Type::Boolean, true] => true,
      [Imagekitio::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Imagekitio::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Imagekitio::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Imagekitio::Internal::Type::Converter.new_coerce_state
      Imagekitio::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Imagekitio::Internal::Type::Converter.dump(target, input, state: state)
...
class Imagekitio::Test::EnumModelTest < Minitest::Test
  class E0
    include Imagekitio::Internal::Type::Enum
...
class Imagekitio::Test::CollectionModelTest < Minitest::Test
  A1 = Imagekitio::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Imagekitio::Internal::Type::HashOf[Integer]

  A2 = Imagekitio::Internal::Type::ArrayOf[H1]
  H2 = Imagekitio::Internal::Type::HashOf[-> { A1 }]

  A3 = Imagekitio::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Imagekitio::Internal::Type::HashOf[Integer, nil?: true]
...
class Imagekitio::Test::BaseModelTest < Minitest::Test
  class M1 < Imagekitio::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Imagekitio::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Imagekitio::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Imagekitio::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Imagekitio::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Imagekitio::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Imagekitio::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Imagekitio::Errors::ConversionError => e
...
class Imagekitio::Test::UnionTest < Minitest::Test
  class U0
    include Imagekitio::Internal::Type::Union
  ...
  class M2 < Imagekitio::Internal::Type::BaseModel
  ...
  class M4 < Imagekitio::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Imagekitio::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Imagekitio::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Imagekitio::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Imagekitio::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Imagekitio::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Imagekitio::Internal::Type::Unknown, Imagekitio::Internal::Type::Unknown] => true,
      [Imagekitio::Internal::Type::Boolean, Imagekitio::Internal::Type::Boolean] => true,
      [Imagekitio::Internal::Type::Unknown, Imagekitio::Internal::Type::Boolean] => false,
...
class Imagekitio::Test::MetaInfoTest < Minitest::Test
  A1 = Imagekitio::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Imagekitio::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
