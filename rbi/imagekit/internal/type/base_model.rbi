    ...
    module Type
      class BaseModel
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Imagekit::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Imagekit::Internal::Type::BaseModel::KnownField,
                  { type: Imagekit::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Imagekit::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Imagekit::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Imagekit::Internal::AnyHash) }
        def to_h
        end
