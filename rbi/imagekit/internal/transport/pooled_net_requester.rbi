      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                Imagekit::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: Imagekit::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: Imagekit::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
