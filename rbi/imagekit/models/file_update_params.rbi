        ...
        class UpdateFileDetails < Imagekit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  T.any(
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension,
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension,
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension
                  )
                ]
              )
            )
          ...
          sig do
            params(
              extensions:
                T::Array[
                  T.any(
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::OrHash,
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension::OrHash,
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension::OrHash
                  )
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T.any(
                  T::Array[String],
                  Imagekit::FileUpdateParams::Update::UpdateFileDetails::RemoveAITags::OrSymbol
                )
              )
            )
          end
          ...
          module Extension
            ...
            class RemovedotBgExtension < Imagekit::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Name::OrSymbol
                )
              end
              attr_accessor :name
              ...
              sig do
                params(
                  options:
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Options::OrHash
                ).void
              end
              attr_writer :options
              ...
              module Name
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Name
                    )
                  end
                ...
                REMOVE_BG =
                  T.let(
                    :"remove-bg",
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::RemovedotBgExtension::Name::TaggedSymbol
                  )
            ...
            class AutoTaggingExtension < Imagekit::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension::Name::OrSymbol
                )
              end
              attr_accessor :name
              ...
              module Name
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension::Name
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
                ...
                GOOGLE_AUTO_TAGGING =
                  T.let(
                    :"google-auto-tagging",
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoTaggingExtension::Name::TaggedSymbol
                  )
                AWS_AUTO_TAGGING =
                  T.let(
                    :"aws-auto-tagging",
            ...
            class AutoDescriptionExtension < Imagekit::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension::Name::OrSymbol
                )
              end
              attr_accessor :name
              ...
              module Name
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension::Name
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
                ...
                AI_AUTO_DESCRIPTION =
                  T.let(
                    :"ai-auto-description",
                    Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::AutoDescriptionExtension::Name::TaggedSymbol
                  )
            ...
            sig do
              override.returns(
                T::Array[
                  Imagekit::FileUpdateParams::Update::UpdateFileDetails::Extension::Variants
                ]
              )
            end
            def self.variants
          ...
          module RemoveAITags
            ...
            Variants =
              T.type_alias do
                T.any(
                  T::Array[String],
                  Imagekit::FileUpdateParams::Update::UpdateFileDetails::RemoveAITags::TaggedSymbol
                )
              end
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::FileUpdateParams::Update::UpdateFileDetails::RemoveAITags
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
