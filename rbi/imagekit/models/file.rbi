...
module Imagekit
  module Models
    class File < Imagekit::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Hash[Symbol, Imagekit::File::SelectedFieldsSchema])
        )
      end
      ...
      sig do
        params(
          selected_fields_schema:
            T::Hash[Symbol, Imagekit::File::SelectedFieldsSchema::OrHash]
        ).void
      end
        ...
        override.returns(
          {
            ...
            name: String,
            selected_fields_schema:
              T::Hash[Symbol, Imagekit::File::SelectedFieldsSchema],
            size: Float,
            tags: T.nilable(T::Array[String]),
            thumbnail: String,
      ...
      class SelectedFieldsSchema < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(Imagekit::File::SelectedFieldsSchema::Type::TaggedSymbol)
        end
        attr_accessor :type
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::File::SelectedFieldsSchema::DefaultValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(Imagekit::File::SelectedFieldsSchema::MaxValue::Variants)
          )
        end
        ...
        sig do
          params(
            max_value: Imagekit::File::SelectedFieldsSchema::MaxValue::Variants
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Imagekit::File::SelectedFieldsSchema::MinValue::Variants)
          )
        end
        ...
        sig do
          params(
            min_value: Imagekit::File::SelectedFieldsSchema::MinValue::Variants
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Imagekit::File::SelectedFieldsSchema::SelectOption::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            type: Imagekit::File::SelectedFieldsSchema::Type::OrSymbol,
            default_value:
              Imagekit::File::SelectedFieldsSchema::DefaultValue::Variants,
        ...
        sig do
          override.returns(
            {
              type: Imagekit::File::SelectedFieldsSchema::Type::TaggedSymbol,
              default_value:
                Imagekit::File::SelectedFieldsSchema::DefaultValue::Variants,
              is_value_required: T::Boolean,
              max_length: Float,
              max_value:
                Imagekit::File::SelectedFieldsSchema::MaxValue::Variants,
              min_length: Float,
              min_value:
                Imagekit::File::SelectedFieldsSchema::MinValue::Variants,
              read_only: T::Boolean,
              select_options:
                T::Array[
                  Imagekit::File::SelectedFieldsSchema::SelectOption::Variants
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Imagekit::File::SelectedFieldsSchema::Type)
            end
          ...
          TEXT =
            T.let(
              :Text,
              Imagekit::File::SelectedFieldsSchema::Type::TaggedSymbol
            )
          TEXTAREA =
            T.let(
              :Textarea,
          ...
          sig do
            override.returns(
              T::Array[Imagekit::File::SelectedFieldsSchema::Type::TaggedSymbol]
            )
          end
          def self.values
          end
          ...
          Variants =
            T.type_alias do
              T.any(
                ...
                T::Boolean,
                T::Array[
                  Imagekit::File::SelectedFieldsSchema::DefaultValue::Mixed::Variants
                ]
              )
            end
          ...
          MixedArray =
            T.let(
              Imagekit::Internal::Type::ArrayOf[
                union: Imagekit::File::SelectedFieldsSchema::DefaultValue::Mixed
              ],
        ...
        module MaxValue
          ...
          sig do
            override.returns(
              T::Array[Imagekit::File::SelectedFieldsSchema::MaxValue::Variants]
            )
          end
          def self.variants
          end
        ...
        module MinValue
          ...
          sig do
            override.returns(
              T::Array[Imagekit::File::SelectedFieldsSchema::MinValue::Variants]
            )
          end
          def self.variants
          end
