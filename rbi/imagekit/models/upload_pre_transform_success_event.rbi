    ...
    class UploadPreTransformSuccessEvent < Imagekit::Models::BaseWebhookEvent
      ...
      class Data < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Hash[
                Symbol,
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema
              ]
            )
          )
        end
        ...
        sig do
          params(
            selected_fields_schema:
              T::Hash[
                Symbol,
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::OrHash
              ]
          ).void
        end
        ...
        class SelectedFieldsSchema < Imagekit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::DefaultValue::Variants
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::MaxValue::Variants
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::MinValue::Variants
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::SelectOption::Variants
                ]
              )
            )
          end
          ...
          sig do
            params(
              type:
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::Type::OrSymbol,
              default_value:
                Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::DefaultValue::Variants,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            Variants =
              T.type_alias do
                T.any(
                  ...
                  T::Boolean,
                  T::Array[
                    Imagekit::UploadPreTransformSuccessEvent::Data::SelectedFieldsSchema::DefaultValue::Mixed::Variants
                  ]
                )
              end
