  ...
  module Models
    class FileUploadV1Response < Imagekit::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Imagekit::Models::FileUploadV1Response,
      ...
      sig do
        returns(
          T.nilable(T::Array[Imagekit::Models::FileUploadV1Response::AITag])
        )
      end
      ...
      sig do
        returns(
          T.nilable(Imagekit::Models::FileUploadV1Response::EmbeddedMetadata)
        )
      end
      ...
      sig do
        params(
          embedded_metadata:
            Imagekit::Models::FileUploadV1Response::EmbeddedMetadata::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Imagekit::Models::FileUploadV1Response::ExtensionStatus)
        )
      end
      ...
      sig do
        params(
          extension_status:
            Imagekit::Models::FileUploadV1Response::ExtensionStatus::OrHash
        ).void
      end
      ...
      sig do
        returns(T.nilable(Imagekit::Models::FileUploadV1Response::Metadata))
      end
      attr_reader :metadata

      sig do
        params(
          metadata: Imagekit::Models::FileUploadV1Response::Metadata::OrHash
        ).void
      end
      ...
      sig do
        returns(T.nilable(Imagekit::Models::FileUploadV1Response::VersionInfo))
      end
      ...
      sig do
        params(
          version_info:
            Imagekit::Models::FileUploadV1Response::VersionInfo::OrHash
        ).void
      end
      ...
      sig do
        params(
          ai_tags:
            T.nilable(
              T::Array[Imagekit::Models::FileUploadV1Response::AITag::OrHash]
            ),
          audio_codec: String,
          bit_rate: Integer,
        ...
        override.returns(
          {
            ai_tags:
              T.nilable(
                T::Array[Imagekit::Models::FileUploadV1Response::AITag]
              ),
            audio_codec: String,
            bit_rate: Integer,
            custom_coordinates: T.nilable(String),
            ...
            is_private_file: T::Boolean,
            is_published: T::Boolean,
            metadata: Imagekit::Models::FileUploadV1Response::Metadata,
            name: String,
            size: Float,
            tags: T.nilable(T::Array[String]),
            thumbnail_url: String,
            url: String,
            version_info: Imagekit::Models::FileUploadV1Response::VersionInfo,
            video_codec: String,
            width: Float
          }
        )
      ...
      class AITag < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::FileUploadV1Response::AITag,
              Imagekit::Internal::AnyHash
            )
          end
      ...
      class ExtensionStatus < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::FileUploadV1Response::ExtensionStatus::AwsAutoTagging::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            aws_auto_tagging:
              Imagekit::Models::FileUploadV1Response::ExtensionStatus::AwsAutoTagging::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::FileUploadV1Response::ExtensionStatus::GoogleAutoTagging::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            google_auto_tagging:
              Imagekit::Models::FileUploadV1Response::ExtensionStatus::GoogleAutoTagging::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::FileUploadV1Response::ExtensionStatus::RemoveBg::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            remove_bg:
              Imagekit::Models::FileUploadV1Response::ExtensionStatus::RemoveBg::OrSymbol
          ).void
        end
        ...
        module AwsAutoTagging
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Imagekit::Models::FileUploadV1Response::ExtensionStatus::AwsAutoTagging
              )
            end
        ...
        module GoogleAutoTagging
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Imagekit::Models::FileUploadV1Response::ExtensionStatus::GoogleAutoTagging
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module RemoveBg
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Imagekit::Models::FileUploadV1Response::ExtensionStatus::RemoveBg
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Metadata < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::FileUploadV1Response::Metadata,
              Imagekit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Imagekit::Models::FileUploadV1Response::Metadata::Exif)
          )
        end
        attr_reader :exif
        ...
        sig do
          params(
            exif: Imagekit::Models::FileUploadV1Response::Metadata::Exif::OrHash
          ).void
        end
        attr_writer :exif
        ...
        sig do
          params(
            ...
            duration: Integer,
            exif:
              Imagekit::Models::FileUploadV1Response::Metadata::Exif::OrHash,
            format_: String,
          ...
          override.returns(
            {
              ...
              density: Integer,
              duration: Integer,
              exif: Imagekit::Models::FileUploadV1Response::Metadata::Exif,
              format_: String,
              has_color_profile: T::Boolean,
              has_transparency: T::Boolean,
              height: Integer,
        ...
        class Exif < Imagekit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekit::Models::FileUploadV1Response::Metadata::Exif,
                Imagekit::Internal::AnyHash
              )
            end
