    ...
    module Accounts
      ...
      module OriginListResponseItem
        ...
        class S3 < Imagekit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Imagekit::Models::Accounts::OriginListResponseItem::S3::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              ...
              prefix: String,
              type:
                Imagekit::Models::Accounts::OriginListResponseItem::S3::Type::OrSymbol,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::Models::Accounts::OriginListResponseItem::S3::Type
                )
              end
        ...
        class S3Compatible < Imagekit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Imagekit::Models::Accounts::OriginListResponseItem::S3Compatible::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              ...
              type:
                Imagekit::Models::Accounts::OriginListResponseItem::S3Compatible::Type::OrSymbol,
              base_url_for_canonical_header: String
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::Models::Accounts::OriginListResponseItem::S3Compatible::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
