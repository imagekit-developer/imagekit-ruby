...
module Imagekit
  module Models
    module Accounts
      class URLEndpointUpdateParams < Imagekit::Internal::Type::BaseModel
          ...
          returns(
            T.nilable(
              T.any(
                ...
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::ImgixURLRewriter,
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::AkamaiURLRewriter
              )
            )
          )
        end
        ...
        module URLRewriter
          ...
          class CloudinaryURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::CloudinaryURLRewriter::Type::OrSymbol
              )
            end
            attr_accessor :type
            ...
            module Type
              ...
              CLOUDINARY =
                T.let(
                  :CLOUDINARY,
                  Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::CloudinaryURLRewriter::Type::TaggedSymbol
                )
          ...
          class ImgixURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::ImgixURLRewriter::Type::OrSymbol
              )
            end
            attr_accessor :type
            ...
            module Type
              ...
              IMGIX =
                T.let(
                  :IMGIX,
                  Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::ImgixURLRewriter::Type::TaggedSymbol
                )
          ...
          class AkamaiURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::AkamaiURLRewriter::Type::OrSymbol
              )
            end
            attr_accessor :type
            ...
            module Type
              ...
              AKAMAI =
                T.let(
                  :AKAMAI,
                  Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::AkamaiURLRewriter::Type::TaggedSymbol
                )
          ...
          sig do
            override.returns(
              T::Array[
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::Variants
              ]
            )
          end
          def self.variants
