      ...
      class URLEndpointUpdateParams < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T.any(
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::Cloudinary,
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::Imgix,
                Imagekit::Accounts::URLEndpointUpdateParams::URLRewriter::Akamai
              )
            )
          )
        end
