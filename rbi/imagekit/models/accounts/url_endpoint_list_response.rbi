    ...
    module Accounts
      class URLEndpointListResponseItem < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::Accounts::URLEndpointListResponseItem,
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::Variants
            )
          )
        end
        ...
        module URLRewriter
          ...
          class CloudinaryURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::CloudinaryURLRewriter::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                ...
                type:
                  Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::CloudinaryURLRewriter::Type::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(
              # Whether to preserve `<asset_type>/<delivery_type>` in the rewritten URL.
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::CloudinaryURLRewriter::Type
                  )
                end
          ...
          class ImgixURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::ImgixURLRewriter::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                type:
                  Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::ImgixURLRewriter::Type::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(type:)
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::ImgixURLRewriter::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class AkamaiURLRewriter < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::AkamaiURLRewriter::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                type:
                  Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::AkamaiURLRewriter::Type::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(type:)
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Imagekit::Models::Accounts::URLEndpointListResponseItem::URLRewriter::AkamaiURLRewriter::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
