      ...
      module V2
        class FileUploadParams < Imagekit::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Imagekit::Beta::V2::FileUploadParams,
          ...
          sig do
            returns(
              T.nilable(
                T::Hash[
                  Symbol,
                  Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(Imagekit::Beta::V2::FileUploadParams::Transformation)
            )
          end
            ...
            override.returns(
              {
                ...
                tags: T::Array[String],
                transformation:
                  Imagekit::Beta::V2::FileUploadParams::Transformation,
                use_unique_file_name: T::Boolean,
                webhook_url: String,
          ...
          module ResponseField
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::Beta::V2::FileUploadParams::ResponseField
                )
              end
          ...
          class SelectedFieldsSchema < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::Type::OrSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              returns(
                T.nilable(
                  Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::DefaultValue::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::MaxValue::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::MinValue::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::SelectOption::Variants
                  ]
                )
              )
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              TEXT =
                T.let(
                  :Text,
                  Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::Type::TaggedSymbol
                )
              TEXTAREA =
                T.let(
                  :Textarea,
              ...
              Variants =
                T.type_alias do
                  T.any(
                    ...
                    T::Boolean,
                    T::Array[
                      Imagekit::Beta::V2::FileUploadParams::SelectedFieldsSchema::DefaultValue::Mixed::Variants
                    ]
                  )
                end
          ...
          class Transformation < Imagekit::Internal::Type::BaseModel
            ...
            module Post
              ...
              sig do
                override.returns(
                  T::Array[
                    Imagekit::Beta::V2::FileUploadParams::Transformation::Post::Variants
                  ]
                )
              end
              def self.variants
