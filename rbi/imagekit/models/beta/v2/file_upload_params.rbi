        ...
        class FileUploadParams < Imagekit::Internal::Type::BaseModel
          ...
          module Extension
            ...
            class AutoTaggingExtension < Imagekit::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Imagekit::Beta::V2::FileUploadParams::Extension::AutoTaggingExtension::Name::OrSymbol
                )
              end
              attr_accessor :name
              ...
              module Name
                ...
                GOOGLE_AUTO_TAGGING =
                  T.let(
                    :"google-auto-tagging",
                    Imagekit::Beta::V2::FileUploadParams::Extension::AutoTaggingExtension::Name::TaggedSymbol
                  )
                AWS_AUTO_TAGGING =
                  T.let(
                    :"aws-auto-tagging",
            ...
            sig do
              override.returns(
                T::Array[
                  Imagekit::Beta::V2::FileUploadParams::Extension::Variants
                ]
              )
            end
            def self.variants
