  ...
  module Models
    class FileUploadResponse < Imagekit::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Hash[
              Symbol,
              Imagekit::Models::FileUploadResponse::SelectedFieldsSchema
            ]
          )
        )
      end
      ...
      sig do
        params(
          selected_fields_schema:
            T::Hash[
              Symbol,
              Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::OrHash
            ]
        ).void
      end
      ...
      class SelectedFieldsSchema < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::DefaultValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::MaxValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::MinValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::SelectOption::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            type:
              Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::Type::OrSymbol,
            default_value:
              Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::DefaultValue::Variants,
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          Variants =
            T.type_alias do
              T.any(
                ...
                T::Boolean,
                T::Array[
                  Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::DefaultValue::Mixed::Variants
                ]
              )
            end
          ...
          MixedArray =
            T.let(
              Imagekit::Internal::Type::ArrayOf[
                union:
                  Imagekit::Models::FileUploadResponse::SelectedFieldsSchema::DefaultValue::Mixed
              ],
