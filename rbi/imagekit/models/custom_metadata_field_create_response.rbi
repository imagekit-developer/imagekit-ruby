  ...
  module Models
    class CustomMetadataFieldCreateResponse < Imagekit::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Imagekit::Models::CustomMetadataFieldCreateResponse,
      ...
      sig do
        returns(Imagekit::Models::CustomMetadataFieldCreateResponse::Schema)
      end
      attr_reader :schema
      ...
      sig do
        params(
          schema:
            Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::OrHash
        ).void
      end
      attr_writer :schema
      ...
      class Schema < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::CustomMetadataFieldCreateResponse::Schema,
              Imagekit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::MaxValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::MinValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::SelectOption::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            type:
              Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::Type::OrSymbol,
            default_value:
              Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::Variants,
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::Type
              )
            end
        ...
        module DefaultValue
          ...
          Variants =
            T.type_alias do
              T.any(
                Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::UnionMember0::Variants,
                T::Array[
                  Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::JsonScalarArray::Variants
                ]
              )
            end
          ...
          JsonScalar2DArray =
            T.let(
              Imagekit::Internal::Type::ArrayOf[
                union:
                  Imagekit::Models::CustomMetadataFieldCreateResponse::Schema::DefaultValue::JsonScalarArray
              ],
