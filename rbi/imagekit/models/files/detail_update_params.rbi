  ...
  module Models
    module Files
      class DetailUpdateParams < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                T.any(
                  Imagekit::Files::DetailUpdateParams::Extension::RemovedotBgExtension,
                  Imagekit::Files::DetailUpdateParams::Extension::AutoTaggingExtension
                )
              ]
            )
          )
        ...
        sig { returns(T.nilable(Imagekit::Files::DetailUpdateParams::Publish)) }
        attr_reader :publish
          ...
          override.returns(
            {
              ...
              tags: T.nilable(T::Array[String]),
              webhook_url: String,
              publish: Imagekit::Files::DetailUpdateParams::Publish,
        ...
        module Extension
          ...
          class RemovedotBgExtension < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Name::OrSymbol
              )
            end
            attr_accessor :name
            ...
            sig do
              params(
                options:
                  Imagekit::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Options::OrHash
              ).void
            end
            attr_writer :options
            ...
            module Name
              ...
              REMOVE_BG =
                T.let(
                  :"remove-bg",
                  Imagekit::Files::DetailUpdateParams::Extension::RemovedotBgExtension::Name::TaggedSymbol
                )
          ...
          class AutoTaggingExtension < Imagekit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Imagekit::Files::DetailUpdateParams::Extension::AutoTaggingExtension::Name::OrSymbol
              )
            end
            attr_accessor :name
            ...
            module Name
              ...
              GOOGLE_AUTO_TAGGING =
                T.let(
                  :"google-auto-tagging",
                  Imagekit::Files::DetailUpdateParams::Extension::AutoTaggingExtension::Name::TaggedSymbol
                )
              AWS_AUTO_TAGGING =
                T.let(
                  :"aws-auto-tagging",
          ...
          sig do
            override.returns(
              T::Array[Imagekit::Files::DetailUpdateParams::Extension::Variants]
            )
          end
          def self.variants
          end
        ...
        module RemoveAITags
          ...
          Variants =
            T.type_alias do
              T.any(
                T::Array[String],
                Imagekit::Files::DetailUpdateParams::RemoveAITags::TaggedSymbol
              )
            end
          ...
          sig do
            override.returns(
              T::Array[
                Imagekit::Files::DetailUpdateParams::RemoveAITags::Variants
              ]
            )
          end
          def self.variants
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Imagekit::Files::DetailUpdateParams::RemoveAITags)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Publish < Imagekit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekit::Files::DetailUpdateParams::Publish,
                Imagekit::Internal::AnyHash
              )
            end
