  ...
  module Models
    module Files
      class MetadataGetFromURLResponse < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Imagekit::Models::Files::MetadataGetFromURLResponse::Exif)
          )
        end
        attr_reader :exif
        ...
        sig do
          params(
            exif:
              Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::OrHash
          ).void
        end
        attr_writer :exif
          ...
          override.returns(
            {
              ...
              density: Integer,
              duration: Integer,
              exif: Imagekit::Models::Files::MetadataGetFromURLResponse::Exif,
              format_: String,
              has_color_profile: T::Boolean,
              has_transparency: T::Boolean,
              height: Integer,
        ...
        class Exif < Imagekit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif,
                Imagekit::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Exif
              )
            )
          end
          attr_reader :exif
          ...
          sig do
            params(
              exif:
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Exif::OrHash
            ).void
          end
          attr_writer :exif
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Gps
              )
            )
          end
          attr_reader :gps
          ...
          sig do
            params(
              gps:
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Gps::OrHash
            ).void
          end
          attr_writer :gps
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Image
              )
            )
          end
          attr_reader :image
          ...
          sig do
            params(
              image:
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Image::OrHash
            ).void
          end
          attr_writer :image
          ...
          sig do
            params(
              interoperability:
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Interoperability::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Thumbnail
              )
            )
          end
          ...
          sig do
            params(
              thumbnail:
                Imagekit::Models::Files::MetadataGetFromURLResponse::Exif::Thumbnail::OrHash
            ).void
          end
