    ...
    module Files
      class VersionListResponseItem < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::Files::VersionListResponseItem,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Imagekit::Models::Files::VersionListResponseItem::AITag]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekit::Models::Files::VersionListResponseItem::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              Imagekit::Models::Files::VersionListResponseItem::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        sig do
          params(
            version_info:
              Imagekit::Models::Files::VersionListResponseItem::VersionInfo::OrHash
          ).void
        end
        ...
        sig do
          params(
            ai_tags:
              T.nilable(
                T::Array[
                  Imagekit::Models::Files::VersionListResponseItem::AITag::OrHash
                ]
              ),
            created_at: Time,
          ...
          override.returns(
            {
              ai_tags:
                T.nilable(
                  T::Array[
                    Imagekit::Models::Files::VersionListResponseItem::AITag
                  ]
                ),
              created_at: Time,
              custom_coordinates: T.nilable(String),
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Imagekit::Models::Files::VersionListResponseItem::Type
              )
            end
