    ...
    module Files
      class DetailUpdateResponse < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Imagekit::Models::Files::DetailUpdateResponse::AITag]
            )
          )
        end
        ...
        sig do
          params(
            extension_status:
              Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::OrHash
          ).void
        end
        ...
        sig do
          params(
            version_info:
              Imagekit::Models::Files::DetailUpdateResponse::VersionInfo::OrHash
          ).void
        end
        ...
        sig do
          params(
            ai_tags:
              T.nilable(
                T::Array[
                  Imagekit::Models::Files::DetailUpdateResponse::AITag::OrHash
                ]
              ),
            created_at: String,
        ...
        class AITag < Imagekit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekit::Models::Files::DetailUpdateResponse::AITag,
                Imagekit::Internal::AnyHash
              )
            end
        ...
        class ExtensionStatus < Imagekit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::AwsAutoTagging::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              aws_auto_tagging:
                Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::AwsAutoTagging::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::GoogleAutoTagging::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              google_auto_tagging:
                Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::GoogleAutoTagging::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::RemoveBg::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              remove_bg:
                Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::RemoveBg::OrSymbol
            ).void
          end
          ...
          module AwsAutoTagging
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::AwsAutoTagging
                )
              end
          ...
          module GoogleAutoTagging
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::GoogleAutoTagging
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module RemoveBg
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Imagekit::Models::Files::DetailUpdateResponse::ExtensionStatus::RemoveBg
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
