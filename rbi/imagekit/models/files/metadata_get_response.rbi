      ...
      class MetadataGetResponse < Imagekit::Internal::Type::BaseModel
        ...
        class Exif < Imagekit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::MetadataGetResponse::Exif::Exif
              )
            )
          end
          attr_reader :exif
          ...
          sig do
            params(
              exif:
                Imagekit::Models::Files::MetadataGetResponse::Exif::Exif::OrHash
            ).void
          end
          attr_writer :exif
          ...
          sig do
            returns(
              T.nilable(Imagekit::Models::Files::MetadataGetResponse::Exif::Gps)
            )
          end
          attr_reader :gps
          ...
          sig do
            params(
              gps:
                Imagekit::Models::Files::MetadataGetResponse::Exif::Gps::OrHash
            ).void
          end
          attr_writer :gps
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::MetadataGetResponse::Exif::Image
              )
            )
          end
          attr_reader :image
          ...
          sig do
            params(
              image:
                Imagekit::Models::Files::MetadataGetResponse::Exif::Image::OrHash
            ).void
          end
          attr_writer :image
          ...
          sig do
            returns(
              T.nilable(
                Imagekit::Models::Files::MetadataGetResponse::Exif::Interoperability
              )
            )
          end
          ...
          sig do
            params(
              interoperability:
                Imagekit::Models::Files::MetadataGetResponse::Exif::Interoperability::OrHash
            ).void
          end
          ...
          sig do
            params(
              thumbnail:
                Imagekit::Models::Files::MetadataGetResponse::Exif::Thumbnail::OrHash
            ).void
          end
          ...
          sig do
            override.returns(
              {
                exif: Imagekit::Models::Files::MetadataGetResponse::Exif::Exif,
                gps: Imagekit::Models::Files::MetadataGetResponse::Exif::Gps,
                image:
                  Imagekit::Models::Files::MetadataGetResponse::Exif::Image,
                interoperability:
                  Imagekit::Models::Files::MetadataGetResponse::Exif::Interoperability,
          ...
          class Gps < Imagekit::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Imagekit::Models::Files::MetadataGetResponse::Exif::Gps,
                  Imagekit::Internal::AnyHash
                )
              end
