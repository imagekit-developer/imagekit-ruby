    ...
    module Files
      class DetailRetrieveResponse < Imagekit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Imagekit::Models::Files::DetailRetrieveResponse::AITag]
            )
          )
        end
        ...
        sig do
          params(
            version_info:
              Imagekit::Models::Files::DetailRetrieveResponse::VersionInfo::OrHash
          ).void
        end
        ...
        sig do
          params(
            ai_tags:
              T.nilable(
                T::Array[
                  Imagekit::Models::Files::DetailRetrieveResponse::AITag::OrHash
                ]
              ),
            created_at: String,
          ...
          override.returns(
            {
              ai_tags:
                T.nilable(
                  T::Array[
                    Imagekit::Models::Files::DetailRetrieveResponse::AITag
                  ]
                ),
              created_at: String,
              custom_coordinates: T.nilable(String),
