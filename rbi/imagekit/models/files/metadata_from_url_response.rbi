...
module Imagekit
  module Models
    module Files
      class MetadataFromURLResponse < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::Files::MetadataFromURLResponse,
        ...
        sig do
          returns(
            T.nilable(Imagekit::Models::Files::MetadataFromURLResponse::Exif)
          )
        end
        attr_reader :exif
        ...
        sig do
          params(
            exif: Imagekit::Models::Files::MetadataFromURLResponse::Exif::OrHash
          ).void
        end
        attr_writer :exif
        ...
        sig do
          params(
            ...
            duration: Integer,
            exif:
              Imagekit::Models::Files::MetadataFromURLResponse::Exif::OrHash,
            format_: String,
          ...
          override.returns(
            {
              ...
              density: Integer,
              duration: Integer,
              exif: Imagekit::Models::Files::MetadataFromURLResponse::Exif,
              format_: String,
              has_color_profile: T::Boolean,
              has_transparency: T::Boolean,
              height: Integer,
        ...
        class Exif < Imagekit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekit::Models::Files::MetadataFromURLResponse::Exif,
                Imagekit::Internal::AnyHash
              )
            end
