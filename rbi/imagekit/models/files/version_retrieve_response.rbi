    ...
    module Files
      class VersionRetrieveResponse < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::Files::VersionRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Imagekit::Models::Files::VersionRetrieveResponse::AITag]
            )
          )
        end
        ...
        sig do
          params(
            version_info:
              Imagekit::Models::Files::VersionRetrieveResponse::VersionInfo::OrHash
          ).void
        end
        ...
        sig do
          params(
            ai_tags:
              T.nilable(
                T::Array[
                  Imagekit::Models::Files::VersionRetrieveResponse::AITag::OrHash
                ]
              ),
            created_at: String,
          ...
          override.returns(
            {
              ai_tags:
                T.nilable(
                  T::Array[
                    Imagekit::Models::Files::VersionRetrieveResponse::AITag
                  ]
                ),
              created_at: String,
              custom_coordinates: T.nilable(String),
