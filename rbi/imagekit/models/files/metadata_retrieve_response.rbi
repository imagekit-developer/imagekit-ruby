    ...
    module Files
      class MetadataRetrieveResponse < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::Files::MetadataRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(Imagekit::Models::Files::MetadataRetrieveResponse::Exif)
          )
        end
        attr_reader :exif
        ...
        sig do
          params(
            exif:
              Imagekit::Models::Files::MetadataRetrieveResponse::Exif::OrHash
          ).void
        end
        attr_writer :exif
          ...
          override.returns(
            {
              ...
              density: Integer,
              duration: Integer,
              exif: Imagekit::Models::Files::MetadataRetrieveResponse::Exif,
              format_: String,
              has_color_profile: T::Boolean,
              has_transparency: T::Boolean,
              height: Integer,
        ...
        class Exif < Imagekit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekit::Models::Files::MetadataRetrieveResponse::Exif,
                Imagekit::Internal::AnyHash
              )
            end
