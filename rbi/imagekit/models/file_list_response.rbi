  ...
  module Models
    class FileListResponseItem < Imagekit::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Imagekit::Models::FileListResponseItem,
      ...
      sig do
        returns(
          T.nilable(T::Array[Imagekit::Models::FileListResponseItem::AITag])
        )
      end
      ...
      sig do
        returns(T.nilable(Imagekit::Models::FileListResponseItem::VersionInfo))
      end
      ...
      sig do
        params(
          version_info:
            Imagekit::Models::FileListResponseItem::VersionInfo::OrHash
        ).void
      end
      ...
      sig do
        params(
          ai_tags:
            T.nilable(
              T::Array[Imagekit::Models::FileListResponseItem::AITag::OrHash]
            ),
          created_at: String,
        ...
        override.returns(
          {
            ai_tags:
              T.nilable(
                T::Array[Imagekit::Models::FileListResponseItem::AITag]
              ),
            created_at: String,
            custom_coordinates: T.nilable(String),
            custom_metadata: T.anything,
            ...
            updated_at: String,
            url: String,
            version_info: Imagekit::Models::FileListResponseItem::VersionInfo,
            width: Float
          }
        )
      end
      ...
      class AITag < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::FileListResponseItem::AITag,
              Imagekit::Internal::AnyHash
            )
          end
      ...
      class VersionInfo < Imagekit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekit::Models::FileListResponseItem::VersionInfo,
              Imagekit::Internal::AnyHash
            )
          end
