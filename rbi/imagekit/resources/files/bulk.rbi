    ...
    class Files
      class Bulk
        ...
        sig do
          ...
          ).returns(Imagekit::Models::Files::BulkDeleteResponse)
        end
        def delete(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Imagekit::RequestOptions::OrHash
          ).returns(Imagekit::Models::Files::BulkAddTagsResponse)
        end
        def add_tags(
        ...
        sig do
          params(
            ...
            file_ids: T::Array[String],
            request_options: Imagekit::RequestOptions::OrHash
          ).returns(Imagekit::Models::Files::BulkRemoveAITagsResponse)
        end
        def remove_ai_tags(
        ...
        sig do
          params(
            ...
            tags: T::Array[String],
            request_options: Imagekit::RequestOptions::OrHash
          ).returns(Imagekit::Models::Files::BulkRemoveTagsResponse)
        end
        def remove_tags(
