  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Imagekitio::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        sig do
          overridable
            .params(
              value: T.anything,
              state: Imagekitio::Internal::Type::Converter::CoerceState
            )
            .returns(T.anything)
        end
        ...
        sig do
          overridable
            .params(
              value: T.anything,
              state: Imagekitio::Internal::Type::Converter::DumpState
            )
            .returns(T.anything)
        end
        ...
        class << self
                ...
                T.any(
                  {
                    ...
                    enum:
                      T.nilable(
                        T.proc.returns(
                          Imagekitio::Internal::Type::Converter::Input
                        )
                      ),
                    union:
                      T.nilable(
                  ...
                  T.proc.returns(Imagekitio::Internal::Type::Converter::Input),
                  Imagekitio::Internal::Type::Converter::Input
                )
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Imagekitio::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Imagekitio::Internal::Type::Converter::Input,
              value: T.anything,
              state: Imagekitio::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
