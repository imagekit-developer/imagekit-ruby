      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    Imagekitio::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              req:
                Imagekitio::Internal::Transport::BaseClient::RequestComponents
            ).void
          end
          def validate!(req)
          end
          ...
          sig do
            params(
              request:
                Imagekitio::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
              response_headers: T::Hash[String, String]
            ).returns(Imagekitio::Internal::Transport::BaseClient::RequestInput)
          end
          ...
          sig do
            params(
              status: T.any(Integer, Imagekitio::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(Imagekitio::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req:
                Imagekitio::Internal::Transport::BaseClient::RequestComponents,
              opts: Imagekitio::Internal::AnyHash
            )
            .returns(Imagekitio::Internal::Transport::BaseClient::RequestInput)
        end
        ...
        sig do
          params(
            request: Imagekitio::Internal::Transport::BaseClient::RequestInput,
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: Imagekitio::Internal::Type::Unknown,
          options: {}
        )
        end
