...
module Imagekitio
  class Client < Imagekitio::Internal::Transport::BaseClient
    ...
    sig { returns(Imagekitio::Resources::Folders) }
    attr_reader :folders

    sig { returns(Imagekitio::Resources::Accounts) }
    attr_reader :accounts

    sig { returns(Imagekitio::Resources::Beta) }
    attr_reader :beta

    sig { returns(Imagekitio::Resources::Webhooks) }
    ...
    def self.new(
      ...
      max_retries: Imagekitio::Client::DEFAULT_MAX_RETRIES,
      timeout: Imagekitio::Client::DEFAULT_TIMEOUT_IN_SECONDS,
      initial_retry_delay: Imagekitio::Client::DEFAULT_INITIAL_RETRY_DELAY,
      max_retry_delay: Imagekitio::Client::DEFAULT_MAX_RETRY_DELAY
    )
    end
  end
end
