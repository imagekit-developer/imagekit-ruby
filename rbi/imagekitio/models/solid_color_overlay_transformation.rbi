  ...
  module Models
    class SolidColorOverlayTransformation < Imagekitio::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Imagekitio::SolidColorOverlayTransformation,
      ...
      sig do
        returns(
          T.nilable(
            Imagekitio::SolidColorOverlayTransformation::Width::Variants
          )
        )
      end
      attr_reader :width
      ...
      module Gradient
        ...
        sig do
          override.returns(
            T::Array[
              Imagekitio::SolidColorOverlayTransformation::Gradient::Variants
            ]
          )
        end
        def self.variants
      ...
      module Radius
        ...
        sig do
          override.returns(
            T::Array[
              Imagekitio::SolidColorOverlayTransformation::Radius::Variants
            ]
          )
        end
        def self.variants
