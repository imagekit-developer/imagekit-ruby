    ...
    module UpdateFileRequest
      ...
      class UpdateFileDetails < Imagekitio::Internal::Type::BaseModel
        ...
        module RemoveAITags
          ...
          sig do
            override.returns(
              T::Array[
                Imagekitio::UpdateFileRequest::UpdateFileDetails::RemoveAITags::Variants
              ]
            )
          end
          def self.variants
      ...
      class ChangePublicationStatus < Imagekitio::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Imagekitio::UpdateFileRequest::ChangePublicationStatus::Publish
            )
          )
        end
        attr_reader :publish
        ...
        sig do
          params(
            publish:
              Imagekitio::UpdateFileRequest::ChangePublicationStatus::Publish::OrHash
          ).void
        end
        attr_writer :publish
      ...
      sig do
        override.returns(T::Array[Imagekitio::UpdateFileRequest::Variants])
      end
      def self.variants
      end
    end
