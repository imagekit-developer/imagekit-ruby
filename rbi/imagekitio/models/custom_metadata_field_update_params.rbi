  ...
  module Models
    class CustomMetadataFieldUpdateParams < Imagekitio::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Imagekitio::CustomMetadataFieldUpdateParams,
      ...
      # existing `type`.
      sig do
        returns(T.nilable(Imagekitio::CustomMetadataFieldUpdateParams::Schema))
      end
      attr_reader :schema
      ...
      class Schema < Imagekitio::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Imagekitio::CustomMetadataFieldUpdateParams::Schema,
              Imagekitio::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Imagekitio::CustomMetadataFieldUpdateParams::Schema::DefaultValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekitio::CustomMetadataFieldUpdateParams::Schema::MaxValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Imagekitio::CustomMetadataFieldUpdateParams::Schema::MinValue::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Imagekitio::CustomMetadataFieldUpdateParams::Schema::SelectOption::Variants
              ]
            )
          )
        end
          ...
          Variants =
            T.type_alias do
              T.any(
                ...
                T::Boolean,
                T::Array[
                  Imagekitio::CustomMetadataFieldUpdateParams::Schema::DefaultValue::Mixed::Variants
                ]
              )
            end
