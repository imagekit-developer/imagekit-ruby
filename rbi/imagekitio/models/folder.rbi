...
module Imagekitio
  module Models
    class Folder < Imagekitio::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Imagekitio::Folder, Imagekitio::Internal::AnyHash)
        end
      ...
      # Type of the asset.
      sig { returns(T.nilable(Imagekitio::Folder::Type::TaggedSymbol)) }
      attr_reader :type

      sig { params(type: Imagekitio::Folder::Type::OrSymbol).void }
      attr_writer :type
      ...
      sig do
        params(
          ...
          folder_path: String,
          name: String,
          type: Imagekitio::Folder::Type::OrSymbol,
          updated_at: Time
        ...
        override.returns(
          {
            ...
            folder_path: String,
            name: String,
            type: Imagekitio::Folder::Type::TaggedSymbol,
            updated_at: Time
          }
        )
      end
      ...
      module Type
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Imagekitio::Folder::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        FOLDER = T.let(:folder, Imagekitio::Folder::Type::TaggedSymbol)

        sig do
          override.returns(T::Array[Imagekitio::Folder::Type::TaggedSymbol])
        end
        def self.values
        end
      end
