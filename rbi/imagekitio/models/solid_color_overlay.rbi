...
module Imagekitio
  module Models
    class SolidColorOverlay < Imagekitio::Models::BaseOverlay
      ...
      sig do
        returns(
          T.nilable(T::Array[Imagekitio::SolidColorOverlayTransformation])
        )
      end
      ...
      sig do
        params(
          transformation:
            T::Array[Imagekitio::SolidColorOverlayTransformation::OrHash]
        ).void
      end
        ...
        override.returns(
          {
            ...
            type: Symbol,
            transformation:
              T::Array[Imagekitio::SolidColorOverlayTransformation]
          }
        )
      end
      def to_hash
