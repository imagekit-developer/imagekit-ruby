...
module Imagekitio
  module Models
    class Metadata < Imagekitio::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Imagekitio::Metadata, Imagekitio::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Imagekitio::Metadata::Exif)) }
      attr_reader :exif

      sig { params(exif: Imagekitio::Metadata::Exif::OrHash).void }
      attr_writer :exif
      ...
      sig do
        params(
          ...
          density: Integer,
          duration: Integer,
          exif: Imagekitio::Metadata::Exif::OrHash,
          format_: String,
      ...
      class Exif < Imagekitio::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
        ...
        sig { returns(T.nilable(Imagekitio::Metadata::Exif::Exif)) }
        attr_reader :exif

        sig { params(exif: Imagekitio::Metadata::Exif::Exif::OrHash).void }
        attr_writer :exif

        # Object containing GPS information.
        sig { returns(T.nilable(Imagekitio::Metadata::Exif::Gps)) }
        attr_reader :gps

        sig { params(gps: Imagekitio::Metadata::Exif::Gps::OrHash).void }
        attr_writer :gps

        # Object containing EXIF image information.
        sig { returns(T.nilable(Imagekitio::Metadata::Exif::Image)) }
        attr_reader :image

        sig { params(image: Imagekitio::Metadata::Exif::Image::OrHash).void }
        attr_writer :image

        # JSON object.
        sig { returns(T.nilable(Imagekitio::Metadata::Exif::Interoperability)) }
        attr_reader :interoperability

        sig do
          params(
            interoperability:
              Imagekitio::Metadata::Exif::Interoperability::OrHash
          ).void
        end
        ...
        sig do
          params(thumbnail: Imagekitio::Metadata::Exif::Thumbnail::OrHash).void
        end
        attr_writer :thumbnail

        sig do
          params(
            exif: Imagekitio::Metadata::Exif::Exif::OrHash,
            gps: Imagekitio::Metadata::Exif::Gps::OrHash,
            image: Imagekitio::Metadata::Exif::Image::OrHash,
            interoperability:
              Imagekitio::Metadata::Exif::Interoperability::OrHash,
            makernote: T::Hash[Symbol, T.anything],
            thumbnail: Imagekitio::Metadata::Exif::Thumbnail::OrHash
          ).returns(T.attached_class)
        end
        def self.new(
          # Object containing Exif details.
        ...
        sig do
          override.returns(
            {
              exif: Imagekitio::Metadata::Exif::Exif,
              gps: Imagekitio::Metadata::Exif::Gps,
              image: Imagekitio::Metadata::Exif::Image,
              interoperability: Imagekitio::Metadata::Exif::Interoperability,
              makernote: T::Hash[Symbol, T.anything],
              thumbnail: Imagekitio::Metadata::Exif::Thumbnail
            }
          )
        end
        def to_hash
        ...
        class Image < Imagekitio::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekitio::Metadata::Exif::Image,
                Imagekitio::Internal::AnyHash
              )
            end
        ...
        class Interoperability < Imagekitio::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Imagekitio::Metadata::Exif::Interoperability,
                Imagekitio::Internal::AnyHash
              )
            end
